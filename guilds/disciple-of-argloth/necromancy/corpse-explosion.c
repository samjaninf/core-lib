...
protected void Setup()
{
    ...
    addSpecification("description", "This research teaches the Disciple to rupture an animated corpse in a shower of necrotic shrapnel that tears at all nearby enemies.");
    ...
    addSpecification("command template", "corpse explosion");
    addSpecification("use ability message", "##InitiatorName## detonate##InitiatorReflexive## a corpse in a shower of necrotic shrapnel.");
}
