...
{
    addSpecification("name", "Transmutation Mastery");
    addSpecification("source", "mage");
    addSpecification("description", "This skill provides the mage with "
        "mastery of transmutation principles, enhancing all "
    ...
    addPrerequisite("/guilds/mage/transformation/transmutation-theory.c",
        (["type": "research"]));
