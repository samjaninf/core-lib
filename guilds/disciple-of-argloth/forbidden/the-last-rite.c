...
{
    addSpecification("name", "The Last Rite");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple the last rite - Argloth's personal killing technique, a single blow that carries all the weight of death itself.");
    ...
    addSpecification("command template", "the last rite [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## perform##InitiatorReflexive## the last rite upon ##TargetName##, the weight of death itself behind the blow.");
}
