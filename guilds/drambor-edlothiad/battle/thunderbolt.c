...
protected void Setup()
{
    ...
    addSpecification("description", "This research teaches a massive thunderbolt "
        "that strikes with devastating electrical force.");
    addPrerequisite("/guilds/drambor-edlothiad/battle/tempest.c", (["type": "research"]));
