...
protected void Setup()
{
    ...
    addSpecification("command template", "snare [at ##Target##]");
    ...
    addSpecification("modifiers", ({
        ...
        ([
            "type": "research",
            "research item": "/guilds/rogue/thievery/thieves-insight-x.c",
            "name": "Thieves' Insight X",
            "formula": "multiplicative",
            "base value": 1,
            "rate": 1.25
        ]),
