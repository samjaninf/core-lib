...
{
    addSpecification("name", "Deadly Flourish");
    addSpecification("source", "rogue");
    addSpecification("description", "This research provides the rogue with "
        "the Deadly Flourish blade combat technique.");

    addPrerequisite("/guilds/rogue/blade-craft/supreme-blade.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "deadly flourish [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::deliver## a precise deadly flourish "
        "at ##TargetName##.");
