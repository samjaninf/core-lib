...
{
    addSpecification("name", "Rite of Mending");
    addSpecification("source", "druid");
    addSpecification("description", "This research grants the druid "
        "knowledge of the rite of mending - a simple healing ritual "
        "performed by crushing yarrow and invoking nature's restorative "
        "power.");
    ...
    addSpecification("command template", "rite of mending");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::crush## yarrow between "
        "##InitiatorPossessive## palms and ##Infinitive::invoke## "
        "nature's healing touch, green light flowing from the herbs.");
    addSpecification("use ability fail message", "##InitiatorName## "
        "##Infinitive::reach## for yarrow but ##Infinitive::find## "
        "none - the rite of mending requires yarrow.");
}
