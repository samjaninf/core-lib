...
{
    addSpecification("name", "Reshape Body");
    addSpecification("source", "mage");
    addSpecification("description", "A transformation-school attack spell.");

    addPrerequisite("/guilds/mage/transformation/warp-flesh.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "reshape body [at ##Target##]");
    addSpecification("event handler", "reshapeBodyEvent");
    addSpecification("use ability message",
        "##InitiatorName## violently reshape##InitiatorReflexive## ##TargetName##'s body with transformative force.");
    addSpecification("use ability fail message",
        "You failed to reshape ##TargetName##'s body.");
    addSpecification("use ability cooldown message",
        "You must wait before reshaping a body again.");
