...
{
    addSpecification("name", "Death Shot");
    addSpecification("source", "ranger");
    addSpecification("description", "This skill provides the ranger "
        "with the knowledge to fire the perfect killing shot.");
    ...
    addSpecification("event handler", "deathshotEvent");
    addSpecification("command template", "death shot [at ##Target##]");
