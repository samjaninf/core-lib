...
{
    addSpecification("name", "Pillar of Dusk");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the pillar of dusk. A column of deep shadow energy "
        "rises from the ground at a target location, enveloping and "
        "wounding all within its reach.");
    ...
    addPrerequisite("/guilds/hand-of-bilanx/light-and-shadow/shadow-pulse.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "pillarOfDuskEvent");
    addSpecification("command template", "pillar of dusk [##Target##]");
    addSpecification("use ability message", "A column of deep shadow rises "
        "from the ground as ##InitiatorName## calls forth the dusk.");
}
