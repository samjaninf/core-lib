...
protected void Setup()
{
    ...
    addSpecification("description", "This research teaches a cascading wall "
        "of  glacial ice that freezes everything in its path.");
    addPrerequisite(
    ...
    addSpecification("use ability message", "A cascading wall of glacial ice "
        "surges forth from ##InitiatorName##, freezing everything in its "
            "path.");
}