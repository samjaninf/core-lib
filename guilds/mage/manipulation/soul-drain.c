...
protected void Setup()
{
    ...
    addPrerequisite("/guilds/mage/manipulation/arcane-inversion.c",
        (["type": "research"]));
    ...
    addSpecification("use ability message",
        "##InitiatorName## drain##InitiatorReflexive## the very soul from ##TargetName##.");
    addSpecification("use ability fail message",
        "You failed to drain ##TargetName##'s soul.");
    addSpecification("use ability cooldown message",
        "You must wait before draining a soul again.");
