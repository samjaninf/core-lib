...
protected void Setup()
{
    ...
    addSpecification("description", "This research teaches a devastating storm "
        "that combines fire, ice, and lightning into a single cataclysm.");
    addPrerequisite("/guilds/drambor-edlothiad/battle/thunderbolt.c", (["type": "research"]));
    ...
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::call## forth the Storm of Ages, fire, ice, and lightning "
