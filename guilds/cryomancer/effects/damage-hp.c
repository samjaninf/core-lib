...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides knowledge of the cryomancer spell construction component for damaging hit points.");

    addPrerequisite("/guilds/cryomancer/effects/root.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "cryomancerDamageHitPointsEvent");
}
