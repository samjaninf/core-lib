...
{
    addSpecification("name", "Transformative Mastery");
    addSpecification("source", "mage");
    addSpecification("description", "This skill provides the mage with "
        "transformative mastery, enhancing all transformation-based "
        "abilities.");
    ...
    addPrerequisite("/guilds/mage/transformation/total-transformation.c",
        (["type": "research"]));
