...
{
    addSpecification("name", "Amplified Transformation");
    addSpecification("source", "mage");
    addSpecification("description", "This skill provides the mage with "
        "amplified transformation knowledge, enhancing all "
    ...
    addPrerequisite("/guilds/mage/transformation/transformation-theory.c",
        (["type": "research"]));
