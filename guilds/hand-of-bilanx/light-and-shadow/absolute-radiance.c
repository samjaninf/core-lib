...
{
    addSpecification("name", "Absolute Radiance");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the "
        "knowledge of absolute radiance. The priest channels the full "
        "radiant force of the third truth in a catastrophic column of "
        "light that obliterates a single target.");
    ...
    addSpecification("event handler", "absoluteRadianceEvent");
    addSpecification("command template", "absolute radiance [##Target##]");
    addSpecification("use ability message", "##InitiatorName## channels "
        "absolute radiance, the full burning truth of balanced light "
        "obliterating ##TargetName##.");
}
