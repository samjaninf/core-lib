...
{
    addSpecification("name", "Transformer's Call");
    addSpecification("source", "mage");
    addSpecification("description", "This skill provides the mage with "
        "knowledge to further reduce the spell point cost of their "
    ...
    addPrerequisite("/guilds/mage/transformation/transformers-reserve.c",
        (["type": "research"]));
