...
{
	addSpecification("name", "Ice Lance");
	addSpecification("source", "cryomancer");
	addSpecification("description", "This research provides the user with the "
		"knowledge of the ice lance spell. By means of this, the "
		"cryomancer is able to target an enemy with a lance of frozen "
		"energy that damages hit, spell, and stamina points. The "
		"lance is 'vampiric' in nature and the damage done in turn restores "
		"the caster's vitals.");
	...
	addSpecification("event handler", "iceLanceEvent");
	addSpecification("command template", "ice lance [at ##Target##]");
	addSpecification("use ability message", "##InitiatorName## "
		"##Infinitive::utter## words of power and a lance of crystalline "
		"ice erupts from ##InitiatorPossessive## "
