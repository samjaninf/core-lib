...
{
    addSpecification("name", "Searing Enchantment");
    addSpecification("source", "Drambor Edlothiad");
    addSpecification("description", "This research provides the knowledge to "
        "coat a wielded blade in intensified flames.");

    addPrerequisite("/guilds/drambor-edlothiad/enchantment/fire-enchantment.c", (["type": "research"]));
    ...
    addSpecification("command template", "Searing Enchantment");
    addSpecification("use ability message", "Intense flames roar along ##InitiatorPossessive## blade.");
}