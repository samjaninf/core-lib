...
{
    addSpecification("name", "Scholar Strike");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "The death scholar's honed blood strike - "
        "a more powerful version of the acolyte strike.");
    ...
    addSpecification("command template", "scholar strike [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## deliver##InitiatorReflexive## a death scholar's strike upon ##TargetName##.");
}
