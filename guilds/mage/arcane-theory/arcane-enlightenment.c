...
{
    addSpecification("name", "Arcane Enlightenment");
    addSpecification("source", "mage");
    addSpecification("description", "Arcane enlightenment grants greater power across all schools.");

    addPrerequisite("level",
        (["type": "level", "guild": "mage", "value": 45]));
    addPrerequisite("/guilds/mage/arcane-theory/supreme-attunement.c",
        (["type": "research"]));
