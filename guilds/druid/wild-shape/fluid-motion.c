...
protected void Setup()
{
    ...
    addSpecification("description", "This research grants the flowing unpredictable movement of a hunting cat.");
    ...
    addPrerequisite("/guilds/druid/wild-shape/crushing-blow.c",
        ([ "type": "research" ]));
