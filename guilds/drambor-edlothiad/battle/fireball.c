...
protected void Setup()
{
    ...
    addSpecification("description", "This research teaches the classic fireball, a roaring sphere of flame that detonates among the enemy with devastating force, engulfing all in its radius.");
    ...
    addSpecification("use ability message", "##InitiatorName## ##Infinitive::hurl## a roaring fireball that detonates among ##TargetName## and nearby foes.");
}
