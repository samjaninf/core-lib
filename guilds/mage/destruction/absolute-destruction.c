...
protected void Setup()
{
    ...
    addPrerequisite("/guilds/mage/destruction/destructive-mastery.c",
        (["type": "research"]));
    ...
    addSpecification("use ability message",
        "##InitiatorName## reduce##InitiatorReflexive## ##TargetName## to nothing with absolute destructive force.");
    ...
    addSpecification("use ability cooldown message",
        "You must wait before attempting absolute destruction again.");
