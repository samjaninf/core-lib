...
{
    addSpecification("name", "Void Lance");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple to hurl a lance of pure void energy - not shadow, but the emptiness beneath shadow itself.");

    addPrerequisite("/guilds/disciple-of-argloth/shadow/void-walker",
        (["type": "research"]));
    ...
    addSpecification("command template", "void lance [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## hurl##InitiatorReflexive## a lance of pure void at ##TargetName##.");
}
