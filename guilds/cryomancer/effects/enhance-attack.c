...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides knowledge of the cryomancer spell construction component for enhancing attack.");

    addPrerequisite("/guilds/cryomancer/effects/add-hp.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "cryomancerEnhanceAttackEvent");
}
