...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides knowledge of the cryomancer spell construction component for enhancing soak.");

    addPrerequisite("/guilds/cryomancer/effects/enhance-defense.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "cryomancerEnhanceSoakEvent");
}