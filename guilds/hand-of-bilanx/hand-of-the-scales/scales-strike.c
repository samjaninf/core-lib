...
{
    addSpecification("name", "Scales Strike");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the scales strike. The arbiter channels the weight "
        "of Bilanx's judgment into a single focused strike.");
    ...
    addPrerequisite("/guilds/hand-of-bilanx/hand-of-the-scales/fracture-of-will.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "scalesStrikeEvent");
    addSpecification("command template", "scales strike [##Target##]");
    addSpecification("use ability message", "##InitiatorName## drives the "
        "weight of the scales into ##TargetName##.");
}
