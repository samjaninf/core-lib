...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides the user with the "
        "knowledge of the ice storm spell.");
    ...
    addSpecification("use ability message", "##InitiatorName## ##Infinitive::call## forth a raging ice storm that hammers ##TargetName## with shards of ice.");
}
