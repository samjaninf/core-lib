...
protected void Setup()
{
    ...
    addPrerequisite("/guilds/mage/manipulation/vital-siphon.c",
        (["type": "research"]));
    ...
    addSpecification("use ability message",
        "##InitiatorName## tap##InitiatorReflexive## directly into ##TargetName##'s life force.");
    addSpecification("use ability fail message",
        "You failed to tap ##TargetName##'s life force.");
    addSpecification("use ability cooldown message",
        "You must wait before tapping life force again.");
