...
{
    addSpecification("name", "Mass Restoration");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the mass restoration. The hierophant extends the "
        "corrective power of the scales to all allies in the area.");
    ...
    addPrerequisite("/guilds/hand-of-bilanx/hand-of-the-scales/greater-restoration.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "massRestorationEvent");
    addSpecification("command template", "mass restoration");
    addSpecification("use ability message", "##InitiatorName## extends "
        "the scales' corrective power across all nearby allies.");
}
