...
{
    addSpecification("name", "Dissolution Enchantment");
    addSpecification("source", "Drambor Edlothiad");
    addSpecification("description", "This research provides the knowledge to "
        "coat a wielded blade in reality-dissolving acid.");

    addPrerequisite("/guilds/drambor-edlothiad/enchantment/caustic-enchantment.c", (["type": "research"]));
    ...
    addSpecification("bonus acid enchantment", 8);
    ...
    addSpecification("command template", "Dissolution Enchantment");
    addSpecification("use ability message", "Reality-dissolving acid seeps from ##InitiatorPossessive## blade.");
}