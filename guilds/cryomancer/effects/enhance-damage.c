...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides knowledge of the cryomancer spell construction component for enhancing damage.");

    addPrerequisite("/guilds/cryomancer/effects/enhance-attack.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "cryomancerEnhanceDamageEvent");
}
