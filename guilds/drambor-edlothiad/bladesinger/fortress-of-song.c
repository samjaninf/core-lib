...
protected void Setup()
{
    ...
    addPrerequisite("/guilds/drambor-edlothiad/bladesinger/bladesinger-elven-grace.c", (["type": "research"]));
    ...
    addSpecification("use ability message", "A fortress of harmonic energy rises around ##InitiatorName##, singing with power.");
}