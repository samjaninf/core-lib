...
protected void Setup()
{
    ...
    addSpecification("description", "This research grants the druid knowledge of the conflagration spell, creating a massive explosion of primal fire.");

    addPrerequisite("/guilds/druid/natures-wrath/root.c",
        ([ "type": "research" ]));

    addPrerequisite("/guilds/druid/natures-wrath/scorched-earth.c",
        ([ "type": "research" ]));
    ...
    addSpecification("command template", "conflagration ##Target##");
    addSpecification("use ability message", "##InitiatorName## ##Infinitive::spread## ##InitiatorPossessive## arms wide and an immense column of primal fire ##Infinitive::engulf## ##TargetName## from above.");
}
