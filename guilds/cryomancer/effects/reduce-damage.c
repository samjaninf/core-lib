...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides knowledge of the cryomancer spell construction component for reducing damage.");

    addPrerequisite("/guilds/cryomancer/effects/reduce-attack.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "cryomancerReduceDamageEvent");
}
