...
{
    addSpecification("name", "Putrefaction");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple to saturate an area with necrotic rot, causing all living creatures within to rapidly decay.");
    ...
    addSpecification("command template", "putrefaction");
    addSpecification("use ability message", "##InitiatorName## saturate##InitiatorReflexive## the area with a pall of rot and necrotic decay.");
}
