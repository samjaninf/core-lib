...
{
    addSpecification("name", "Sixth Truth Pulse");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the knowledge of the sixth truth pulse. The priest releases a pulse of the sixth truth that sweeps over the entire area.");
    ...
    addSpecification("event handler", "sixthTruthPulseEvent");
    addSpecification("command template", "sixth truth pulse");
    addSpecification("use ability message", "##InitiatorName## releases a pulse of the sixth truth across the area.");
}