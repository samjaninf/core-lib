...
{
    addSpecification("name", "Tidal Wounding");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the "
        "knowledge of tidal wounding. The mirror of tidal mending - a "
        "vast wave of wounding energy crashes across all enemies in the "
        "area, the wounding pan opened to its maximum.");
    ...
    addSpecification("event handler", "tidalWoundingEvent");
    addSpecification("command template", "tidal wounding");
    addSpecification("use ability message", "##InitiatorName## slams the "
        "wounding pan open to its fullest and a tide of harm crashes "
        "across all enemies in the area.");
}
