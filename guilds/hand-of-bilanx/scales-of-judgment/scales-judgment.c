...
{
    addSpecification("name", "Scales' Judgment");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the knowledge of the scales' judgment. The priest pronounces a formal judgment on a target, delivering punishment proportional to their imbalance.");
    ...
    addPrerequisite("/guilds/hand-of-bilanx/scales-of-judgment/balancing-strike.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "scalesJudgmentEvent");
    addSpecification("command template", "scales judgment [##Target##]");
    addSpecification("use ability message", "##InitiatorName## pronounces scales' judgment upon ##TargetName##.");
}