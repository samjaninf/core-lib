...
{
    addSpecification("name", "Inferno Shot");
    addSpecification("source", "ranger");
    addSpecification("description", "This skill provides the ranger "
        "with the knowledge to fire an arrow of pure inferno.");
    ...
    addSpecification("event handler", "infernoshotEvent");
    addSpecification("command template", "inferno shot [at ##Target##]");
