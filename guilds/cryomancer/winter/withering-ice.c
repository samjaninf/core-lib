...
{
    addSpecification("name", "Withering Ice");
    addSpecification("source", "cryomancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the withering ice spell.");

    addPrerequisite("/guilds/cryomancer/winter/whirling-sleet.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "witheringIceEvent");
    addSpecification("command template", "withering ice");
    addSpecification("use ability message", "##InitiatorName## ##Infinitive::unleash## a withering storm of ice that tears through the area.");
}
