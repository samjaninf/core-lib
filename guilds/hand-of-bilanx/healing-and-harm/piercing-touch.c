...
{
    addSpecification("name", "Piercing Touch");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the piercing touch. Where the mending hand soothes, "
        "the piercing touch sharpens the wounding pan, sending a precise "
        "needle of harmful energy into the target.");
    ...
    addSpecification("event handler", "piercingTouchEvent");
    addSpecification("command template", "piercing touch [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## extends two "
        "fingers toward ##TargetName## and releases a precise needle "
        "of wounding energy.");
}
