...
{
    addSpecification("name", "Magical Enchantment");
    addSpecification("source", "Drambor Edlothiad");
    addSpecification("description", "This research provides the knowledge to "
        "imbue a wielded blade with pure arcane force.");
    ...
    addSpecification("command template", "Magical Enchantment");
    addSpecification("use ability message", "Arcane force shimmers along ##InitiatorPossessive## blade.");
}