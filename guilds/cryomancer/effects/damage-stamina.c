...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides knowledge of the cryomancer spell construction component for damaging stamina.");

    addPrerequisite("/guilds/cryomancer/effects/damage-sp.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "cryomancerDamageStaminaEvent");
}
