...
{
    addSpecification("name", "Black Wind");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple to conjure a black wind of death energy that howls through an area, withering all caught in its path.");

    addPrerequisite(
        "/guilds/disciple-of-argloth/death/threshold.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "black wind");
    addSpecification("use ability message", "##InitiatorName## conjure##InitiatorReflexive## a black wind of death that tears through all nearby foes.");
}
