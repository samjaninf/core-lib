...
{
    addSpecification("name", "Necrotic Drain");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple to drain the life force directly from a target, transferring their vitality into the Disciple's own.");
    ...
    addSpecification("command template", "necrotic drain [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## drain##InitiatorReflexive## the life from ##TargetName##, drawing their vitality inward.");
