...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides knowledge of the cryomancer spell construction component for siphoning stamina from a target.");

    addPrerequisite("/guilds/cryomancer/effects/siphon-sp.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "cryomancerSiphonStaminaEvent");
}
