...
{
    addSpecification("name", "Deathblow");
    addSpecification("source", "rogue");
    addSpecification("description", "This research provides the rogue with "
        "the Deathblow opportunistic technique.");

    addPrerequisite("/guilds/rogue/opportunism/finishing-instinct.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "deathblow [at ##Target##]");
