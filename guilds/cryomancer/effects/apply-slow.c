...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides knowledge of the cryomancer spell construction component for slowing a target.");

    addPrerequisite("/guilds/cryomancer/effects/reduce-soak.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "cryomancerApplySlowEvent");
}
