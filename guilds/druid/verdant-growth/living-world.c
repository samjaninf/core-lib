...
{
    addSpecification("name", "Living World");
    addSpecification("source", "druid");
    addSpecification("description", "This research transforms the druid into a living world - carrying the verdant realm within.");
    ...
    addPrerequisite("/guilds/druid/verdant-growth/verdant-apotheosis.c",
        ([ "type": "research" ]));
