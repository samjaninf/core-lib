...
protected void Setup()
{
	...
	addSpecification("description", "This research provides knowledge of siphoning spell points to restore the caster.");
	...
	addSpecification("event handler", "necromancerSiphonSpellPointsEvent");
}