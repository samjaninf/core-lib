...
{
    addSpecification("name", "Frost Enchantment");
    addSpecification("source", "Drambor Edlothiad");
    addSpecification("description", "This research provides the knowledge to "
        "sheath a wielded blade in bitter frost.");
    ...
    addSpecification("command template", "Frost Enchantment");
    addSpecification("use ability message", "Frost creeps along ##InitiatorPossessive## blade, chilling the air.");
}