...
{
    addSpecification("name", "Greater Restoration");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the greater restoration. The hierophant applies a "
        "powerful corrective working that mends both body and spirit "
        "at once.");
    ...
    addPrerequisite("/guilds/hand-of-bilanx/hand-of-the-scales/mending-of-the-scales.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "greaterRestorationEvent");
    addSpecification("command template", "greater restoration [##Target##]");
    addSpecification("use ability message", "##InitiatorName## applies "
        "a greater restoration of balance to ##TargetName##.");
}
