...
{
    addSpecification("name", "Flank Strike");
    addSpecification("source", "rogue");
    addSpecification("description", "This research provides the rogue with "
        "the Flank Strike opportunistic technique.");
    ...
    addSpecification("stamina point cost", 56);
    addSpecification("cooldown", 14);
    addSpecification("command template", "flank strike [at ##Target##]");
