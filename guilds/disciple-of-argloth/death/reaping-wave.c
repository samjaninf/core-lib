...
{
    addSpecification("name", "Reaping Wave");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple to release a wave of death energy that reaps the vitality of all nearby enemies.");

    addPrerequisite(
        "/guilds/disciple-of-argloth/death/death-knell.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "reaping wave");
    addSpecification("use ability message", "##InitiatorName## release##InitiatorReflexive## a reaping wave of death energy across all nearby foes.");
}
