...
{
    addSpecification("name", "Grave Touch");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple to lay the cold touch of the grave upon a target, sapping their vitality and chilling their spirit.");
    ...
    addSpecification("command template", "grave touch [at ##Target##]");
    addSpecification("use ability message",
        "##InitiatorName## lay##InitiatorReflexive## the cold touch of "
        "the grave upon ##TargetName##.");
}
