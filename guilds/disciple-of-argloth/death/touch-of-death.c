...
{
    addSpecification("name", "Touch of Death");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple to channel death directly through their touch, striking a target with a killing pulse of dark energy.");
    ...
    addSpecification("command template", "touch of death [at ##Target##]");
    addSpecification("use ability message",
        "##InitiatorName## channel##InitiatorReflexive## death directly "
        "through ##InitiatorPossessive## touch into ##TargetName##.");
}
