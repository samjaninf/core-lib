...
{
    addSpecification("name", "Black Void");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple to manifest a region of black void that devours the vitality of all caught within it.");
    ...
    addSpecification("command template", "black void");
    addSpecification("use ability message", "##InitiatorName## manifest##InitiatorReflexive## a region of black void that devours all caught within.");
}
