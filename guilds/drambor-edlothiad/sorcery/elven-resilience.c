...
protected void Setup()
{
    ...
    addSpecification("description", "Magical resilience drawn from elven heritage.");
    addPrerequisite("/guilds/drambor-edlothiad/sorcery/timeless-magic.c", (["type": "research"]));
