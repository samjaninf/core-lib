...
{
    addSpecification("name", "Flanking Blow");
    addSpecification("source", "ranger");
    addSpecification("description", "This skill provides the ranger "
        "with the knowledge to strike from an unexpected angle.");

    addPrerequisite("/guilds/ranger/blade-work/close-quarters.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "flankingblowEvent");
    addSpecification("command template", "flanking blow [at ##Target##]");
