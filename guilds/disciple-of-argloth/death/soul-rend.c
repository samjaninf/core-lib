...
protected void Setup()
{
    ...
    addSpecification("description", "This research teaches the Disciple to rend the soul of a target asunder, causing both physical and spiritual agony.");

    addPrerequisite(
        "/guilds/disciple-of-argloth/death/black-wind.c",
        (["type": "research"]));
    ...
    addSpecification("use ability message",
        "##InitiatorName## rend##InitiatorReflexive## the soul of "
        "##TargetName## asunder with raw death energy.");
}
