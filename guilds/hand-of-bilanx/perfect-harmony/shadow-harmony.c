...
{
    addSpecification("name", "Shadow Harmony");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the knowledge of shadow harmony. The Hand channels the shadow aspect of the eighth truth into a focused strike.");
    ...
    addSpecification("event handler", "shadowHarmonyEvent");
    addSpecification("command template", "shadow harmony [##Target##]");
    addSpecification("use ability message", "##InitiatorName## channels shadow harmony at ##TargetName##.");
}