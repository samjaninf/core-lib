...
{
    addSpecification("name", "Law Strike");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the knowledge of the law strike. The priest focuses the second truth's order aspect into a single commanding blow.");
    ...
    addPrerequisite("/guilds/hand-of-bilanx/order-and-chaos/edict-of-binding.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "lawStrikeEvent");
    addSpecification("command template", "law strike [##Target##]");
    addSpecification("use ability message", "##InitiatorName## delivers a law strike at ##TargetName##.");
}