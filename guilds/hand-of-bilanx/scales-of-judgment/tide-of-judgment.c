...
{
    addSpecification("name", "Tide of Judgment");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the knowledge of the tide of judgment. A great wave of fifth truth energy that judges all enemies at once.");
    ...
    addSpecification("event handler", "tideOfJudgmentEvent");
    addSpecification("command template", "tide of judgment");
    addSpecification("use ability message", "##InitiatorName## releases the tide of judgment across the area.");
}