...
{
    addSpecification("name", "Arcane Sight");
    addSpecification("source", "mage");
    addSpecification("description", "A divination-school attack spell.");

    addPrerequisite("/guilds/mage/divination/root.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "arcane sight [at ##Target##]");
    addSpecification("event handler", "arcaneSightEvent");
    addSpecification("use ability message",
        "##InitiatorName## turn##InitiatorReflexive## the power of arcane sight upon ##TargetName## to devastating effect.");
    addSpecification("use ability fail message",
        "You failed to use arcane sight on ##TargetName##.");
    addSpecification("use ability cooldown message",
        "You must wait before using arcane sight again.");
