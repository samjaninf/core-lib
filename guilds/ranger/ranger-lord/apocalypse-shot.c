...
{
    addSpecification("name", "Apocalypse Shot");
    ...
    addSpecification("stamina point cost", 375);
    addSpecification("spell point cost", 350);
    addSpecification("cooldown", 180);

    addSpecification("event handler", "apocalypseshotEvent");
    addSpecification("command template", "apocalypse shot [at ##Target##]");
