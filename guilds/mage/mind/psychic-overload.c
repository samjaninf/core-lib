...
{
    addSpecification("name", "Psychic Overload");
    addSpecification("source", "mage");
    addSpecification("description", "A mind-school attack spell.");

    addPrerequisite("/guilds/mage/mind/psionic-storm.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "psychic overload [at ##Target##]");
    addSpecification("event handler", "psychicOverloadEvent");
    addSpecification("use ability message",
        "##InitiatorName## overload##InitiatorReflexive## ##TargetName##'s mind with pure psychic energy.");
    addSpecification("use ability fail message",
        "You failed to overload ##TargetName##'s mind.");
    addSpecification("use ability cooldown message",
        "You must wait before attempting another psychic overload.");
