...
protected void Setup()
{
    ...
    addSpecification("description", "This research represents supreme mastery of enchanting.");

    addPrerequisite("/guilds/drambor-edlothiad/enchantment/blade-resonance.c", (["type": "research"]));
