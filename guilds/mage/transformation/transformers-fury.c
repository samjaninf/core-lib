...
{
    addSpecification("name", "Transformer's Fury");
    addSpecification("source", "mage");
    addSpecification("description", "This skill provides the mage with "
        "knowledge to greatly reduce the spell point cost of their "
    ...
    addPrerequisite("/guilds/mage/transformation/transformers-might.c",
        (["type": "research"]));
