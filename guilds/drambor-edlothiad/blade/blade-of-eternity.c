...
protected void Setup()
{
    ...
    addSpecification("description", "This research teaches the ultimate technique "
        "of the Drambor Edlothiad: the Blade of Eternity, where the battlemage "
        "channels the accumulated wisdom of millennia into devastating strikes.");

    addPrerequisite("/guilds/drambor-edlothiad/blade/arcane-annihilation.c", (["type": "research"]));
    ...
    addSpecification("modifiers", ({
        ...
        (["type": "research", "research item": "/guilds/drambor-edlothiad/blade/spell-weave-transcendence.c", "name": "spell-weave-transcendence", "formula": "multiplicative", "base value": 1, "rate": 1.25]),
        (["type": "research", "research item": "/guilds/drambor-edlothiad/blade/bladestorm-mastery.c", "name": "bladestorm-mastery", "formula": "multiplicative", "base value": 1, "rate": 1.25]),
        (["type": "skill", "name": "long sword", "formula": "additive", "rate": 0.20]),
