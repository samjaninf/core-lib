...
{
    addSpecification("name", "Resonance Enchantment");
    addSpecification("source", "Drambor Edlothiad");
    addSpecification("description", "This research provides the knowledge to "
        "amplify sonic vibrations through a wielded blade.");

    addPrerequisite("/guilds/drambor-edlothiad/enchantment/sonic-enchantment.c", (["type": "research"]));
    ...
    addSpecification("bonus sonic enchantment", 7);
    ...
    addSpecification("command template", "Resonance Enchantment");
    addSpecification("use ability message", "Powerful vibrations resonate through ##InitiatorPossessive## blade.");
}