...
{
    addSpecification("name", "Ancient Ritualist");
    addSpecification("source", "druid");
    addSpecification("description", "This research marks the druid as a true ancient ritualist, substantially amplifying all primal rites.");
