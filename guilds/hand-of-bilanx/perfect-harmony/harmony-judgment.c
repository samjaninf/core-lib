...
{
    addSpecification("name", "Harmony Judgment");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the knowledge of the harmony judgment. The Hand delivers judgment in the name of the eighth truth upon a single target.");
    ...
    addPrerequisite("/guilds/hand-of-bilanx/perfect-harmony/balanced-insight.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "harmonyJudgmentEvent");
    addSpecification("command template", "harmony judgment [##Target##]");
    addSpecification("use ability message", "##InitiatorName## delivers harmony judgment upon ##TargetName##.");
}