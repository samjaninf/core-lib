...
{
    addSpecification("name", "Total Destruction");
    addSpecification("source", "mage");
    addSpecification("description", "A destruction-school attack spell.");

    addPrerequisite("/guilds/mage/destruction/ruinous-storm.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "total destruction [at ##Target##]");
    addSpecification("event handler", "totalDestructionEvent");
    addSpecification("use ability message",
        "##InitiatorName## unleash##InitiatorReflexive## total destruction upon ##TargetName##.");
    addSpecification("use ability fail message",
        "You failed to unleash total destruction on ##TargetName##.");
    addSpecification("use ability cooldown message",
        "You must wait before attempting total destruction again.");
