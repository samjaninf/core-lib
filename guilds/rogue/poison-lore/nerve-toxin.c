...
{
    addSpecification("name", "Nerve Toxin");
    addSpecification("source", "rogue");
    addSpecification("description", "This research provides the rogue with "
        "the Nerve Toxin poison technique.");

    addPrerequisite("/guilds/rogue/poison-lore/lethal-dosage.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "nerve toxin [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::administer## nerve toxin "
        "to ##TargetName##.");
    ...
    addSpecification("modifiers", ({
        ([
            "type": "research",
            "research item": "/guilds/rogue/poison-lore/venomous-insight-ii.c",
            "name": "Venomous Insight II",
