...
protected void Setup()
{
    ...
    addSpecification("description", "This research teaches the battlemage to call down a single devastating thunderbolt of concentrated electrical fury, striking a foe with the wrath of a storm condensed into a single instant.");
    ...
    addSpecification("use ability message", "##InitiatorName## ##Infinitive::call## down a devastating thunderbolt upon ##TargetName##.");
}
