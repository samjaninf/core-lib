...
{
    addSpecification("name", "Annihilate");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple to annihilate a target's life force in a single overwhelming pulse of death energy.");

    addPrerequisite(
        "/guilds/disciple-of-argloth/death/soul-rend.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "annihilate [at ##Target##]");
    addSpecification("use ability message",
        "##InitiatorName## annihilate##InitiatorReflexive## ##TargetName##'s "
        "life force with an overwhelming pulse of death energy.");
}
