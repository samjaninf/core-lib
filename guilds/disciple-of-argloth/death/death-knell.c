...
{
    addSpecification("name", "Death Knell");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple to strike a target with a peal of death energy that resounds through their soul.");
    ...
    addSpecification("command template", "death knell [at ##Target##]");
    addSpecification("use ability message",
        "##InitiatorName## strike##InitiatorReflexive## ##TargetName## "
        "with a peal of death energy that resounds through their soul.");
}
