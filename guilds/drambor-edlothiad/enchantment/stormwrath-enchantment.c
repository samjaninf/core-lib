...
protected void Setup()
{
    ...
    addPrerequisite("/guilds/drambor-edlothiad/enchantment/thunderstrike-enchantment.c", (["type": "research"]));
    ...
    addSpecification("command template", "Stormwrath Enchantment");
    addSpecification("use ability message", "The wrath of a primordial storm channels through ##InitiatorPossessive## blade.");
}