...
{
    addSpecification("name", "Perfect Disguise");
    addSpecification("source", "League of Assassins");
    addSpecification("description", "This research represents the mastery "
        "of disguise, allowing the assassin to convincingly adopt "
        "almost any appearance or persona.");
    ...
    addSpecification("affected research", (["disguise": 40]));
