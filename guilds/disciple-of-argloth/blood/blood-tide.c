...
{
    addSpecification("name", "Blood Tide");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research provides the Disciple "
        "with knowledge of the blood tide technique - a rolling surge of "
        "sanguine energy driven through their weapon into a single target, "
        "leaving them weakened and drained.");
    SetupResearch();

    addPrerequisite(sprintf(
        "/guilds/disciple-of-argloth/paths/%s/blood/soul-drain.c",
    ...
    addSpecification("command template", "blood tide [at ##Target##]");
    addSpecification("use ability message",
        "##InitiatorName## drive##InitiatorReflexive## a tide of blood "
        "magic through ##InitiatorPossessive## ##InitiatorWeapon## "
        "into ##TargetName##.");
}
