...
protected void Setup()
{
    ...
    addSpecification("description", "This research teaches the Disciple to animate their own shadow as a living weapon, sending it to attack a target.");
    ...
    addSpecification("command template", "living shadow [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## send##InitiatorReflexive## ##InitiatorPossessive## own living shadow to strike ##TargetName##.");
}
