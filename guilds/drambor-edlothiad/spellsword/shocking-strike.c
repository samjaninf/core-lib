...
{
    addSpecification("name", "Shocking Strike");
    addSpecification("source", "Drambor Edlothiad");
    addSpecification("description", "This research provides the knowledge to "
        "channel a bolt of lightning through a melee strike.");
    ...
    addSpecification("command template", "shocking strike");
    addSpecification("use ability message", "Lightning crackles through ##InitiatorPossessive## blade as it strikes.");
}