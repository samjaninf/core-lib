...
{
    addSpecification("name", "Frozen Gale");
    addSpecification("source", "cryomancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the frozen gale spell.");

    addPrerequisite("/guilds/cryomancer/winter/sleet.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "frozenGaleEvent");
    addSpecification("command template", "frozen gale [at ##Target##]");
    addSpecification("use ability message", "A frozen gale tears outward from ##InitiatorName##, engulfing ##TargetName## in howling wind and ice.");
}