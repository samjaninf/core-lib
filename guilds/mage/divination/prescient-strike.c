...
{
    addSpecification("name", "Prescient Strike");
    addSpecification("source", "mage");
    addSpecification("description", "A divination-school attack spell.");

    addPrerequisite("/guilds/mage/divination/foresight-bolt.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "prescient strike [at ##Target##]");
    addSpecification("event handler", "prescientStrikeEvent");
    addSpecification("use ability message",
        "##InitiatorName## deliver##InitiatorReflexive## a prescient strike guided by prophetic vision against ##TargetName##.");
    addSpecification("use ability fail message",
        "You failed to land a prescient strike against ##TargetName##.");
    addSpecification("use ability cooldown message",
        "You must wait before attempting a prescient strike again.");
