...
{
    addSpecification("name", "Unveiled Doom");
    addSpecification("source", "mage");
    addSpecification("description", "A divination-school attack spell.");

    addPrerequisite("/guilds/mage/divination/true-sight-blast.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "unveiled doom [at ##Target##]");
    addSpecification("event handler", "unveiledDoomEvent");
    addSpecification("use ability message",
        "##InitiatorName## unveil##InitiatorReflexive## the doom foreseen for ##TargetName## and bring it to pass.");
    addSpecification("use ability fail message",
        "You failed to unveil the doom of ##TargetName##.");
    addSpecification("use ability cooldown message",
        "You must wait before unveiling doom again.");
