...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides the user with the "
        ...
        "siphoning life from a target to invigorate the caster.");

    addPrerequisite("/guilds/cryomancer/effects/siphon-stamina.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "cryomancerInvigoratingSiphonEvent");
}
