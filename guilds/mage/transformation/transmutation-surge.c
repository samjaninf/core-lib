...
{
    addSpecification("name", "Transmutation Surge");
    addSpecification("source", "mage");
    addSpecification("description", "A transformation-school attack spell.");

    addPrerequisite("/guilds/mage/transformation/reshape-body.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "transmutation surge [at ##Target##]");
    addSpecification("event handler", "transmutationSurgeEvent");
    addSpecification("use ability message",
        "##InitiatorName## surge##InitiatorReflexive## transmutative energy through ##TargetName##.");
    addSpecification("use ability fail message",
        "You failed to surge transmutative energy through ##TargetName##.");
    addSpecification("use ability cooldown message",
        "You must wait before surging transmutation again.");
