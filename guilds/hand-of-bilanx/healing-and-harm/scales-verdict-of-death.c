...
{
    addSpecification("name", "Scales' Verdict of Death");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the scales' verdict of death. The mirror of the "
        "verdict of life - the priest pronounces a verdict of death on a "
        "foe, and the full authority of the wounding pan crashes down with "
        "irresistible force.");
    ...
    addSpecification("event handler", "scalesVerdictOfDeathEvent");
    addSpecification("command template", "scales verdict of death [##Target##]");
    addSpecification("use ability message", "##InitiatorName## pronounces "
        "the scales' verdict of death upon ##TargetName##. The wounding "
        "pan descends with the full authority of Bilanx behind it.");
}
