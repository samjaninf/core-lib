...
{
    addSpecification("name", "Crimson Brand");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple "
        "to brand a target with a mark of living blood, causing their "
        "wounds to continuously bleed and their vitality to drain away "
        "with each passing moment.");
    SetupResearch();

    addPrerequisite(sprintf(
        "/guilds/disciple-of-argloth/paths/%s/blood/vital-rupture.c",
    ...
    addSpecification("command template",
        "crimson brand [at ##Target##]");
    addSpecification("use ability message",
        "##InitiatorName## sear##InitiatorReflexive## a crimson brand "
        "into ##TargetName##, marking them for the blood.");
}
