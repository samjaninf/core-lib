...
{
    addSpecification("name", "Ascendant Endurance");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "The endurance of the high necromancer - supernatural toughness that borders on undeath.");
