...
{
    addSpecification("name", "Venomous Barb");
    addSpecification("source", "ranger");
    addSpecification("description", "This skill provides the ranger "
        "with the knowledge to fire a venomous barb.");
    ...
    addSpecification("event handler", "venomousbarbEvent");
    addSpecification("command template", "venomous barb [at ##Target##]");
