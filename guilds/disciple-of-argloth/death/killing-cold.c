...
{
    addSpecification("name", "Killing Cold");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple to channel the killing cold of the grave into a single devastating bolt.");

    addPrerequisite(
        "/guilds/disciple-of-argloth/death/sever-soul.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "killing cold at ##Target##");
    addSpecification("use ability message",
        "##InitiatorName## hurl##InitiatorReflexive## a killing cold at "
        "##TargetName##.");
}
