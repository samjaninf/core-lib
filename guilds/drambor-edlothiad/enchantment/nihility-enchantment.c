...
protected void Setup()
{
    ...
    addPrerequisite("/guilds/drambor-edlothiad/enchantment/abyssal-enchantment.c", (["type": "research"]));
    ...
    addSpecification("command template", "Nihility Enchantment");
    addSpecification("use ability message", "Pure nothingness radiates from ##InitiatorPossessive## blade.");
}