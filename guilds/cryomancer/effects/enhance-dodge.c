...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides knowledge of the cryomancer spell construction component for enhancing dodge.");

    addPrerequisite("/guilds/cryomancer/effects/enhance-soak.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "cryomancerEnhanceDodgeEvent");
}
