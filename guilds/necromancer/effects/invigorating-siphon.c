...
protected void Setup()
{
	...
	addSpecification("description", "This research provides knowledge of siphoning vitality to greatly restore the caster.");
	...
	addSpecification("event handler", "necromancerInvigoratingEvent");
}