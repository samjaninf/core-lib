...
protected void Setup()
{
    ...
    addSpecification("description", "This research teaches the devastating arcane "
        "annihilation technique, where each blade strike is a focused "
        "detonation of accumulated magical energy.");

    addPrerequisite("/guilds/drambor-edlothiad/blade/spellstorm-strike.c", (["type": "research"]));
    ...
    addSpecification("modifiers", ({
        ...
        (["type": "skill", "name": "long sword", "formula": "additive", "rate": 0.15]),
