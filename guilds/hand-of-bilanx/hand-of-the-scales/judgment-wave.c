...
{
    addSpecification("name", "Judgment Wave");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the judgment wave. The hierophant releases a wave "
        "of cosmic judgment that strikes all enemies in the area.");
    ...
    addSpecification("event handler", "judgmentWaveEvent");
    addSpecification("command template", "judgment wave");
    addSpecification("use ability message", "##InitiatorName## releases "
        "a wave of cosmic judgment that strikes all in the area.");
}
