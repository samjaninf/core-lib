...
{
    addSpecification("name", "Lightning Enchantment");
    addSpecification("source", "Drambor Edlothiad");
    addSpecification("description", "This research provides the knowledge to "
        "infuse a wielded blade with crackling electricity.");
    ...
    addSpecification("command template", "Lightning Enchantment");
    addSpecification("use ability message", "Sparks of lightning arc along ##InitiatorPossessive## blade.");
}