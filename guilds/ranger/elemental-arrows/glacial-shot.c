...
{
    addSpecification("name", "Glacial Shot");
    addSpecification("source", "ranger");
    addSpecification("description", "This skill provides the ranger "
        "with the knowledge to fire a glacial shard of ice.");

    addPrerequisite("/guilds/ranger/elemental-arrows/freezing-focus.c",
        (["type": "research"]));
    ...
    addSpecification("stamina point cost", 105);
    addSpecification("spell point cost", 80);
    addSpecification("cooldown", 60);

    addSpecification("event handler", "glacialshotEvent");
    addSpecification("command template", "glacial shot [at ##Target##]");
