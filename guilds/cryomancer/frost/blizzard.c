...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides the user with the "
        "knowledge of the blizzard spell. By means of this, the "
        "cryomancer conjures a devastating blizzard that batters all "
        "nearby foes with howling winds and biting ice.");

    addPrerequisite("/guilds/cryomancer/frost/frost-discharge.c",
        (["type": "research"]));
    ...
    addSpecification("use ability message", "##InitiatorName## calls forth "
        "a raging blizzard that engulfs ##TargetName## in howling winds "
        "and biting ice.");
}
