...
{
    addSpecification("name", "Chaos Surge");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the chaos surge spell. The priest releases a concentrated "
        "burst of unmaking entropy into a foe, tearing at the ordered "
        "patterns that hold their body together.");
    ...
    addSpecification("event handler", "chaosSurgeEvent");
    addSpecification("command template", "chaos surge [at ##Target##]");
    addSpecification("use ability message", "A crackling torrent of unbound "
        "entropy erupts from ##InitiatorPossessive::Name## hands and slams "
        "into ##TargetName##, unmaking the patterns that hold them whole.");
}
