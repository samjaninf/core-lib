...
{
    addSpecification("name", "Blizzard Arrow");
    addSpecification("source", "ranger");
    addSpecification("description", "This skill provides the ranger "
        "with the knowledge to unleash a blizzard through an arrow.");
    ...
    addSpecification("stamina point cost", 165);
    addSpecification("spell point cost", 130);
    addSpecification("cooldown", 75);

    addSpecification("event handler", "blizzardarrowEvent");
    addSpecification("command template", "blizzard arrow [at ##Target##]");
