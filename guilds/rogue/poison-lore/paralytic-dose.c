...
{
    addSpecification("name", "Paralytic Dose");
    addSpecification("source", "rogue");
    addSpecification("description", "This research provides the rogue with "
        "the Paralytic Dose poison technique.");
    ...
    addSpecification("command template", "paralytic dose [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::administer## paralytic dose "
        "to ##TargetName##.");
