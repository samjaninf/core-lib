...
{
	addSpecification("name", "Rime Burst");
	addSpecification("source", "cryomancer");
	addSpecification("description", "This research provides the user with the "
		"knowledge of the rime burst spell. By means of this, the "
		"cryomancer releases an explosion of hoarfrost at a foe.");
	...
	addSpecification("event handler", "rimeBurstEvent");
	addSpecification("command template", "rime burst [at ##Target##]");
	addSpecification("use ability message", "An explosion of crystalline "
		"rime erupts from ##InitiatorPossessive::Name## "
