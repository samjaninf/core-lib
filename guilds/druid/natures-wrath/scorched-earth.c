...
{
    addSpecification("name", "Scorched Earth");
    addSpecification("source", "druid");
    addSpecification("description", "This research grants the druid knowledge of the scorched earth spell, searing and blighting an area around the target.");

    addPrerequisite("/guilds/druid/natures-wrath/root.c",
        ([ "type": "research" ]));

    addPrerequisite("/guilds/druid/natures-wrath/wildfire.c",
        ([ "type": "research" ]));
    ...
    addSpecification("command template", "scorchedearth ##Target##");
    addSpecification("use ability message", "##InitiatorName## ##Infinitive::call## down the wrath of burning sky and searing ground, the land itself ##Infinitive::ignite## around ##TargetName##.");
}
