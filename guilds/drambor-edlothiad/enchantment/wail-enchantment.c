...
protected void Setup()
{
    ...
    addPrerequisite("/guilds/drambor-edlothiad/enchantment/resonance-enchantment.c", (["type": "research"]));
    ...
    addSpecification("command template", "Wail Enchantment");
    addSpecification("use ability message", "A keening wail emanates from ##InitiatorPossessive## blade.");
}