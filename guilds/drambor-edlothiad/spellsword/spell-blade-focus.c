...
protected void Setup()
{
    ...
    addSpecification("description", "This research deepens focus on the spell blade technique.");

    addPrerequisite("/guilds/drambor-edlothiad/spellsword/mana-surge.c", (["type": "research"]));
