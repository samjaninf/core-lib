...
{
	addSpecification("name", "Cold Snap");
	addSpecification("source", "cryomancer");
	addSpecification("description", "This research provides the user with the "
		"knowledge of the cold snap spell. By means of this, the "
		"cryomancer is able to emit a burst of frigid cold at a foe.");
	...
	addSpecification("event handler", "coldSnapEvent");
	addSpecification("command template", "cold snap [at ##Target##]");
	addSpecification("use ability message", "A burst of frigid cold "
