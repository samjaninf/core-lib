...
{
    addSpecification("name", "Sun's Wrath");
    addSpecification("source", "ranger");
    addSpecification("description", "This skill provides the ranger "
        "with the knowledge to call down the wrath of the sun.");
    ...
    addSpecification("event handler", "sunswrathEvent");
    addSpecification("command template", "suns wrath [at ##Target##]");
