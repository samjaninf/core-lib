...
{
    addSpecification("name", "Shadow Enchantment");
    addSpecification("source", "Drambor Edlothiad");
    addSpecification("description", "This research provides the knowledge to "
        "infuse a wielded blade with shadow energy.");
    ...
    addSpecification("command template", "Shadow Enchantment");
    addSpecification("use ability message", "Tendrils of shadow curl along ##InitiatorPossessive## blade.");
}