...
{
    addSpecification("name", "Cosmic Verdict");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the cosmic verdict. The hierophant delivers a "
        "powerful single-target judgment that strikes with the full weight "
        "of the seventh truth.");
    ...
    addPrerequisite("/guilds/hand-of-bilanx/hand-of-the-scales/judgment-wave.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "cosmicVerdictEvent");
    addSpecification("command template", "cosmic verdict [##Target##]");
    addSpecification("use ability message", "##InitiatorName## delivers "
        "the cosmic verdict upon ##TargetName##.");
}
