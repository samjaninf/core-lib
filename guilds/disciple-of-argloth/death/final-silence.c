...
{
    addSpecification("name", "Final Silence");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple to silence a target permanently, cutting off their connection to life energy in a final crushing blow.");

    addPrerequisite(
        "/guilds/disciple-of-argloth/death/killing-cold.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "final silence [at ##Target##]");
    addSpecification("use ability message",
        "##InitiatorName## bring##InitiatorReflexive## final silence upon "
        "##TargetName## with an overwhelming pulse of death energy.");
}
