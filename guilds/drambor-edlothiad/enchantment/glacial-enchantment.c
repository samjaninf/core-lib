...
{
    addSpecification("name", "Glacial Enchantment");
    addSpecification("source", "Drambor Edlothiad");
    addSpecification("description", "This research provides the knowledge to "
        "sheath a wielded blade in deep frost.");

    addPrerequisite("/guilds/drambor-edlothiad/enchantment/frost-enchantment.c", (["type": "research"]));
    ...
    addSpecification("command template", "Glacial Enchantment");
    addSpecification("use ability message", "Deep frost encases ##InitiatorPossessive## blade, mist rising from the cold.");
}