...
{
    addSpecification("name", "Sunder the Imbalanced");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the "
        "knowledge of sunder the imbalanced. The arbiter strikes with "
        "the cosmic weight of Bilanx's wrath against a target that "
        "exists too far from equilibrium.");
    ...
    addPrerequisite("/guilds/hand-of-bilanx/hand-of-the-scales/scales-strike.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "sunderTheImbalancedEvent");
    addSpecification("command template",
        "sunder the imbalanced [##Target##]");
    addSpecification("use ability message", "##InitiatorName## brings "
        "cosmic judgment down upon ##TargetName##.");
}
