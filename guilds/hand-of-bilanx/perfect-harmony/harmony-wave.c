...
{
    addSpecification("name", "Harmony Wave");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the knowledge of the harmony wave. A large-scale release of the eighth truth that washes over all enemies in the area.");
    ...
    addSpecification("event handler", "harmonyWaveEvent");
    addSpecification("command template", "harmony wave");
    addSpecification("use ability message", "##InitiatorName## releases a wave of the eighth truth across the area.");
}