...
{
    addSpecification("name", "Arcane Drain");
    ...
    addSpecification("command template", "arcane drain [at ##Target##]");
    addSpecification("event handler", "arcaneDrainEvent");
    addSpecification("use ability message",
        "##InitiatorName## drain##InitiatorReflexive## arcane energy from ##TargetName## causing harm.");
    addSpecification("use ability fail message",
        "You failed to drain arcane energy from ##TargetName##.");
    addSpecification("use ability cooldown message",
        "You must wait before draining arcane energy again.");
