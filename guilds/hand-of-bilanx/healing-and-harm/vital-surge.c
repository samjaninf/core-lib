...
{
    addSpecification("name", "Vital Surge");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the "
        "knowledge of vital surge. A powerful pulse of the restorative pan "
        "crashes into the target, not merely mending but flooding their "
        "body with excess life force.");
    ...
    addSpecification("event handler", "vitalSurgeEvent");
    addSpecification("command template", "vital surge [##Target##]");
    addSpecification("use ability message", "##InitiatorName## floods "
        "##TargetName## with the full surge of the restorative pan. "
        "##TargetSubjective## staggers under the excess of vitality.");
}
