...
{
    addSpecification("name", "Tidal Mending");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the "
        "knowledge of tidal mending. The priest releases a vast tide of "
        "restorative energy across the area - all allies caught in it are "
    ...
    addSpecification("event handler", "tidalMendingEvent");
    addSpecification("command template", "tidal mending");
    addSpecification("use ability message", "##InitiatorName## lifts both "
        "arms and a tide of restorative energy rolls outward, soaking "
        "##InitiatorPossessive## allies in healing.");
}
