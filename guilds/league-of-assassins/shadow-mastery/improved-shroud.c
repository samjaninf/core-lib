...
{
    addSpecification("name", "Improved Shroud");
    addSpecification("source", "League of Assassins");
    addSpecification("description", "This research refines the shroud "
        "technique, deepening the shadow concealment and extending "
