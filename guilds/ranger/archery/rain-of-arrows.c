...
{
    addSpecification("name", "Rain of Arrows");
    addSpecification("source", "ranger");
    addSpecification("description", "This skill provides the ranger "
        "with the knowledge to loose a rain of arrows upon the target.");
    ...
    addSpecification("event handler", "rainofarrowsEvent");
    addSpecification("command template", "rain of arrows [at ##Target##]");
