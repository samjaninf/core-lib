...
{
    addSpecification("name", "Ancient Lore");
    addSpecification("source", "druid");
    addSpecification("description", "This research grants the druid "
        "knowledge of ancient ritual traditions, significantly amplifying "
        "all primal rites.");
    ...
    addPrerequisite("/guilds/druid/primal-rites/primal-channeling.c",
        ([ "type": "research" ]));
