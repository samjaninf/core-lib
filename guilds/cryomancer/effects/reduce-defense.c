...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides knowledge of the cryomancer spell construction component for reducing defense.");

    addPrerequisite("/guilds/cryomancer/effects/reduce-damage.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "cryomancerReduceDefenseEvent");
}
