...
protected void Setup()
{
    ...
    addSpecification("description", "This research teaches the ice storm "
        "spell,  summoning a barrage of freezing hail and ice shards.");
    addPrerequisite(
    ...
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::summon## a howling ice storm, pelting the area with "
            "shards of ice.");
}