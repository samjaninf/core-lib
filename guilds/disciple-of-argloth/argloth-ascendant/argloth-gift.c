...
{
    addSpecification("name", "Argloth's Gift");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "The gift of Argloth - the Blood God's direct endowment of power to his highest disciples.");
