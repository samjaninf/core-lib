...
{
    addSpecification("name", "Fifth Truth Strike");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the knowledge of the fifth truth strike. A powerful targeted judgment carrying the full authority of the scales.");
    ...
    addSpecification("event handler", "fifthTruthStrikeEvent");
    addSpecification("command template", "fifth truth strike [##Target##]");
    addSpecification("use ability message", "##InitiatorName## drives the fifth truth's judgment into ##TargetName##.");
}