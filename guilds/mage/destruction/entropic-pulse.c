...
{
    addSpecification("name", "Entropic Pulse");
    ...
    addSpecification("command template", "entropic pulse [at ##Target##]");
    addSpecification("event handler", "entropicPulseEvent");
    addSpecification("use ability message",
        "##InitiatorName## send##InitiatorReflexive## a pulse of entropic energy tearing through ##TargetName##.");
    addSpecification("use ability fail message",
        "You failed to send an entropic pulse at ##TargetName##.");
    addSpecification("use ability cooldown message",
        "You must wait before sending another entropic pulse.");
