...
protected void Setup()
{
	...
	addSpecification("description", "This research provides knowledge of dealing staggering necrotic damage.");
	...
	addSpecification("event handler", "necromancerStaggeringDamageEvent");
}