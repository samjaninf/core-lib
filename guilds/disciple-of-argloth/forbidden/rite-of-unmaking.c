...
{
    addSpecification("name", "Rite of Unmaking");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple the rite of unmaking - a sweeping necrotic ceremony that begins to unmake all living things in an area.");
    ...
    addSpecification("command template", "rite of unmaking");
    addSpecification("use ability message", "##InitiatorName## perform##InitiatorReflexive## the rite of unmaking, necrotic energy washing over all nearby foes.");
}
