...
protected void Setup()
{
    ...
    addSpecification("description", "This research teaches the classic magic "
        "missile  spell, launching multiple tracking bolts of force.");
    addPrerequisite(
    ...
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::launch## a volley of magic missiles at "
            "##TargetName##.");
}