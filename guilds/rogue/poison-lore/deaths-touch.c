...
protected void Setup()
{
    ...
    addSpecification("command template", "deaths touch [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::administer## death's touch "
        "to ##TargetName##.");
