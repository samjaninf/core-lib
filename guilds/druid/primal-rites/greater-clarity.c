...
{
    addSpecification("name", "Greater Clarity");
    addSpecification("source", "druid");
    addSpecification("description", "This research grants the druid "
        "knowledge of the greater clarity rite - combining sage and "
        "lavender to deeply restore magical energy.");
    ...
    addSpecification("command template", "greater clarity");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::blend## sage and lavender and "
        "##Infinitive::breathe## deep, magical energy flooding "
        "back into ##InitiatorPossessive## mind.");
    addSpecification("use ability fail message", "##InitiatorName## "
        "##Infinitive::lack## the required sage and lavender for "
        "the greater clarity rite.");
}