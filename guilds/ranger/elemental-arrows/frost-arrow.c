...
{
    addSpecification("name", "Frost Arrow");
    addSpecification("source", "ranger");
    addSpecification("description", "This skill provides the ranger "
        "with the knowledge to freeze an arrow with bitter cold.");

    addPrerequisite("/guilds/ranger/elemental-arrows/frost-attunement.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "frostarrowEvent");
    addSpecification("command template", "frost arrow [at ##Target##]");
