...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides knowledge of the cryomancer spell construction component for damaging spell points.");
    ...
    addSpecification("event handler", "cryomancerDamageSpellPointsEvent");
}
