...
{
    addSpecification("name", "Blood Void");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple to open a blood void - a tear in reality fueled by blood sacrifice that devours a target's life completely.");
    ...
    addSpecification("command template", "blood void [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## open##InitiatorReflexive## a blood void that devours the life of ##TargetName##.");
}
