...
protected void Setup()
{
    ...
    addSpecification("description", "This research teaches the battlemage to unleash a rapid succession of arcane bolts in a sweeping barrage, saturating the battlefield with raw magical force.");
    ...
    addSpecification("use ability message", "##InitiatorName## ##Infinitive::unleash## a sweeping barrage of arcane bolts upon ##TargetName## and nearby foes.");
}
