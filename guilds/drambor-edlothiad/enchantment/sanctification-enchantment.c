...
protected void Setup()
{
    ...
    addPrerequisite("/guilds/drambor-edlothiad/enchantment/undead-bane-enchantment.c", (["type": "research"]));
    ...
    addSpecification("command template", "Sanctification Enchantment");
    addSpecification("use ability message", "Supreme holy power sanctifies ##InitiatorPossessive## blade.");
}