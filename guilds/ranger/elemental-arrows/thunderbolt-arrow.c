...
{
    addSpecification("name", "Thunderbolt Arrow");
    addSpecification("source", "ranger");
    addSpecification("description", "This skill provides the ranger "
        "with the knowledge to fire a thunderbolt arrow.");
    ...
    addSpecification("event handler", "thunderboltarrowEvent");
    addSpecification("command template", "thunderbolt arrow [at ##Target##]");
