...
{
	addSpecification("name", "Hoarfrost");
	addSpecification("source", "cryomancer");
	addSpecification("description", "This research provides the user with the "
		"knowledge of the hoarfrost spell. By means of this, the "
		"cryomancer hurls razor-sharp crystals of hoarfrost at a foe.");
	...
	addSpecification("event handler", "hoarfrostEvent");
	addSpecification("command template", "hoarfrost [at ##Target##]");
	addSpecification("use ability message", "Razor-sharp crystals of "
		"hoarfrost fly from ##InitiatorPossessive::Name## outstretched "
		"hand into ##TargetName##.");
}
