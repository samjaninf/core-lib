...
protected void Setup()
{
    ...
    addSpecification("description", "The ultimate elven sorcery spell, calling "
        "forth a star of pure creation energy.");
    addPrerequisite("/guilds/drambor-edlothiad/sorcery/primordial-light.c", (["type": "research"]));
    ...
    addSpecification("modifiers", ({
        ...
        (["type": "research", "research item": "/guilds/drambor-edlothiad/sorcery/sorcery-transcendence.c", "name": "sorcery-transcendence", "formula": "multiplicative", "base value": 1, "rate": 1.25]),
        (["type": "skill", "name": "spellcraft", "formula": "logarithmic", "rate": 2.50]),
        (["type": "level", "name": "level", "formula": "logarithmic", "rate": 1.30]),
        (["type": "attribute", "name": "wisdom", "formula": "additive", "rate": 0.15]),
    }));
