...
protected void Setup()
{
    ...
    addSpecification("description", "This research achieves legendary status as a spell sword.");

    addPrerequisite("/guilds/drambor-edlothiad/spellsword/living-weapon.c", (["type": "research"]));
