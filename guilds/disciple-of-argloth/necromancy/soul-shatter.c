...
protected void Setup()
{
    ...
    addSpecification("description", "This research teaches the Disciple to strike directly at a target's soul, shattering their connection to their own life force.");
    ...
    addSpecification("use ability message", "##InitiatorName## shatter##InitiatorReflexive## the soul of ##TargetName## with a burst of death magic.");
}
