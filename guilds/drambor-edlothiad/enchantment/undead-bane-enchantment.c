...
protected void Setup()
{
    ...
    addPrerequisite("/guilds/drambor-edlothiad/enchantment/holy-enchantment.c", (["type": "research"]));
    ...
    addSpecification("command template", "Undead Bane Enchantment");
    addSpecification("use ability message", "Pale light flickers along ##InitiatorPossessive## blade, anathema to the undead.");
}