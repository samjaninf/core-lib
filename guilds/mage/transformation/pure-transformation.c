...
{
    addSpecification("name", "Pure Transformation");
    addSpecification("source", "mage");
    addSpecification("description", "This skill provides the mage with "
        "knowledge of pure transformation, enhancing all "
    ...
    addPrerequisite("/guilds/mage/transformation/transformation-mastery.c",
        (["type": "research"]));
