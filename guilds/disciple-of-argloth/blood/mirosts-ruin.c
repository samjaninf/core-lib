...
{
    addSpecification("name", "Mirost's Ruin");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research recovers the forbidden "
        "technique of Mirost the Undying, one of Argloth's most devoted "
        "disciples. Mirost's Ruin channels blood corruption directly into "
        "the soul of a target, unmaking their connection to living essence.");
    SetupResearch();

    addPrerequisite(sprintf(
        "/guilds/disciple-of-argloth/paths/%s/blood/life-fracture.c",
    ...
    addSpecification("spell point cost", 290);
    ...
    addSpecification("command template",
        "mirosts ruin [at ##Target##]");
    addSpecification("use ability message",
        "##InitiatorName## invoke##InitiatorReflexive## Mirost's Ruin "
        "upon ##TargetName##, unmaking their soul with blood corruption.");
}
