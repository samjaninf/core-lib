...
protected void Setup()
{
    ...
    addPrerequisite("/guilds/drambor-edlothiad/spellsword/spell-strike-supremacy.c", (["type": "research"]));
    ...
    addSpecification("use ability message", "##InitiatorName## ##Infinitive::unleash## a cataclysmic strike of devastating arcane power.");
}