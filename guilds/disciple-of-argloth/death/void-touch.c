...
protected void Setup()
{
    ...
    addSpecification("description", "This research teaches the Disciple to touch a target with the void of death - an emptiness so total it unmakes their connection to life.");

    addPrerequisite(
        "/guilds/disciple-of-argloth/death/mortality.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "void touch at ##Target##");
    addSpecification("use ability message",
        "##InitiatorName## touch##InitiatorReflexive## ##TargetName## with "
        "the void.");
}
