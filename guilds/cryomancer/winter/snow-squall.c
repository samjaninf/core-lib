...
{
    addSpecification("name", "Snow Squall");
    addSpecification("source", "cryomancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the snow squall spell.");
    ...
    addSpecification("event handler", "snowSquallEvent");
    addSpecification("command template", "snow squall [at ##Target##]");
    addSpecification("use ability message", "A howling snow squall erupts from ##InitiatorPossessive::Name## hand and engulfs ##TargetName##.");
}
