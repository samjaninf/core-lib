...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides knowledge of reducing a target's defense.");
    ...
    addSpecification("event handler", "necromancerReduceDefenseEvent");
}
