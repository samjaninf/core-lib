...
protected void Setup()
{
    ...
    addSpecification("command template", "entropy wave [at ##Target##]");
    addSpecification("event handler", "entropyWaveEvent");
    addSpecification("use ability message",
        "##InitiatorName## send##InitiatorReflexive## a wave of entropic energy washing over ##TargetName##.");
    addSpecification("use ability fail message",
        "You failed to send an entropy wave at ##TargetName##.");
    addSpecification("use ability cooldown message",
        "You must wait before sending another entropy wave.");
