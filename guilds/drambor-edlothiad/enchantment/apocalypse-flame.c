...
protected void Setup()
{
    ...
    addPrerequisite("/guilds/drambor-edlothiad/enchantment/hellfire-enchantment.c", (["type": "research"]));
    ...
    addSpecification("command template", "Apocalypse Flame");
    addSpecification("use ability message", "World-ending flame engulfs ##InitiatorPossessive## blade, reality buckling from the heat.");
}