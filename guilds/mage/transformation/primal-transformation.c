...
{
    addSpecification("name", "Primal Transformation");
    addSpecification("source", "mage");
    addSpecification("description", "This skill provides the mage with "
        "knowledge of primal transformation forces, enhancing all "
    ...
    addPrerequisite("/guilds/mage/transformation/pure-transformation.c",
        (["type": "research"]));
