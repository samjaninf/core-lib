...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides knowledge of the cryomancer spell construction component for reducing dodge.");
    ...
    addSpecification("event handler", "cryomancerReduceDodgeEvent");
}