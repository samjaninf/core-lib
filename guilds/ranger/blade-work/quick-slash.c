...
{
    addSpecification("name", "Quick Slash");
    addSpecification("source", "ranger");
    addSpecification("description", "This skill provides the ranger "
        "with the knowledge to deliver a lightning-fast slash.");
    ...
    addSpecification("event handler", "quickslashEvent");
    addSpecification("command template", "quick slash [at ##Target##]");
