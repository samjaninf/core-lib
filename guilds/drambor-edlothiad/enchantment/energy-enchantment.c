...
{
    addSpecification("name", "Energy Enchantment");
    addSpecification("source", "Drambor Edlothiad");
    addSpecification("description", "This research provides the knowledge to "
        "infuse a wielded blade with raw energy.");
    ...
    addSpecification("command template", "Energy Enchantment");
    addSpecification("use ability message", "Raw energy pulses through ##InitiatorPossessive## blade.");
}