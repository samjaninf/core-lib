...
{
    addSpecification("name", "Numbing Grasp");
    addSpecification("source", "cryomancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the numbing grasp spell.");
    ...
    addSpecification("event handler", "numbingGraspEvent");
    addSpecification("command template", "numbing grasp [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## ##Infinitive::reach## out with a hand of numbing cold, clutching ##TargetName##.");
}