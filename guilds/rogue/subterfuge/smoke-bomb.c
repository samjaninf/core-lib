...
{
    addSpecification("name", "Smoke Bomb");
    addSpecification("source", "rogue");
    addSpecification("description", "This research provides the rogue with "
        "the Smoke Bomb subterfuge technique.");

    addPrerequisite("/guilds/rogue/subterfuge/deceptive-strike.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "smoke bomb [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::employ## smoke bomb "
        "against ##TargetName##.");
