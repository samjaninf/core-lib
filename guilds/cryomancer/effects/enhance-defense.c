...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides knowledge of the cryomancer spell construction component for enhancing defense.");

    addPrerequisite("/guilds/cryomancer/effects/enhance-damage.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "cryomancerEnhanceDefenseEvent");
}