...
{
    addSpecification("name", "Dissolving Shot");
    addSpecification("source", "ranger");
    addSpecification("description", "This skill provides the ranger "
        "with the knowledge to fire a dissolving acid arrow.");
    ...
    addSpecification("event handler", "dissolvingshotEvent");
    addSpecification("command template", "dissolving shot [at ##Target##]");
