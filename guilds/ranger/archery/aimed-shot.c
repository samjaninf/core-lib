...
{
    addSpecification("name", "Aimed Shot");
    addSpecification("source", "ranger");
    addSpecification("description", "This skill provides the ranger "
        "with the knowledge to carefully aim for a vital point.");
    ...
    addSpecification("event handler", "aimedshotEvent");
    addSpecification("command template", "aimed shot [at ##Target##]");
