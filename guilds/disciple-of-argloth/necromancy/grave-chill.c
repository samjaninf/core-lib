...
{
    addSpecification("name", "Grave Chill");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple to draw the chill of the grave into a target, numbing their body and spirit.");
    ...
    addSpecification("command template", "grave chill [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## draw##InitiatorReflexive## the chill of the grave into ##TargetName##, numbing them to the bone.");
}
