...
protected void Setup()
{
    ...
    addSpecification("description", "This research gradually transforms the druid's flesh toward the permanence of living stone.");
    ...
    addPrerequisite("/guilds/druid/ancient-ward/fortress-of-nature.c",
        ([ "type": "research" ]));
