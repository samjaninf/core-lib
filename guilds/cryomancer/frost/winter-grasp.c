...
{
	addSpecification("name", "Winter's Grasp");
	addSpecification("source", "cryomancer");
	addSpecification("description", "This research provides the user with the "
		"knowledge of the winter's grasp spell. By means of this, the "
		"cryomancer causes a sudden grip of intense cold to strike a foe.");
	...
	addSpecification("event handler", "winterGraspEvent");
	addSpecification("command template", "winter grasp [at ##Target##]");
	addSpecification("use ability message", "A skeletal hand of ice "
		"reaches from ##InitiatorPossessive::Name## "
		"##InitiatorWeapon## and grips ##TargetName##.");
}
