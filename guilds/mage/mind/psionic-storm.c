...
{
    addSpecification("name", "Psionic Storm");
    addSpecification("source", "mage");
    addSpecification("description", "A mind-school attack spell.");

    addPrerequisite("/guilds/mage/mind/neural-disruption.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "psionic storm [at ##Target##]");
    addSpecification("event handler", "psionicStormEvent");
    addSpecification("use ability message",
        "##InitiatorName## unleash##InitiatorReflexive## a storm of psionic energy upon ##TargetName##.");
    addSpecification("use ability fail message",
        "You failed to unleash a psionic storm upon ##TargetName##.");
    addSpecification("use ability cooldown message",
        "You must wait before unleashing another psionic storm.");
