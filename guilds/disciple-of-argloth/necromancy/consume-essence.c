...
{
    addSpecification("name", "Consume Essence");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple to consume the very essence of a target, annihilating their life force and absorbing it entirely.");
    ...
    addSpecification("command template", "consume essence [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## consume##InitiatorReflexive## the essence of ##TargetName##, absorbing their life force entirely.");
