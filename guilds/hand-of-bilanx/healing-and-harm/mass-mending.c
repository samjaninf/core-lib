...
{
    addSpecification("name", "Mass Mending");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the "
        "knowledge of mass mending. The priest opens the restorative pan "
        "wide, flooding the area with mending energy that soothes all "
        "allies' wounds simultaneously.");
    ...
    addSpecification("event handler", "massMendingEvent");
    addSpecification("command template", "mass mending");
    addSpecification("use ability message", "##InitiatorName## throws both "
        "arms wide and the restorative pan floods outward, mending wounds "
        "across the area.");
}
