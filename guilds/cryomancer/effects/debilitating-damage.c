...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides knowledge of dealing cold damage that debilitates and reduces the target's damage capabilities.");

    addPrerequisite("/guilds/cryomancer/effects/reduce-parry.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "cryomancerDebilitatingDamageEvent");
}