...
{
    addSpecification("name", "Arcane Inversion");
    addSpecification("source", "mage");
    addSpecification("description", "A manipulation-school attack spell.");

    addPrerequisite("/guilds/mage/manipulation/life-tap.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "arcane inversion [at ##Target##]");
    addSpecification("event handler", "arcaneInversionEvent");
    addSpecification("use ability message",
        "##InitiatorName## invert##InitiatorReflexive## the arcane energies within ##TargetName## with devastating effect.");
    addSpecification("use ability fail message",
        "You failed to invert arcane energies within ##TargetName##.");
    addSpecification("use ability cooldown message",
        "You must wait before inverting arcane energies again.");
