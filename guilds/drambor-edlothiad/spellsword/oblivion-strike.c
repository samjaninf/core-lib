...
protected void Setup()
{
    ...
    addPrerequisite("/guilds/drambor-edlothiad/spellsword/arcane-cataclysm-strike.c", (["type": "research"]));
    ...
    addSpecification("use ability message", "##InitiatorName## ##Infinitive::deliver## the Oblivion Strike, reality tearing around the blade.");
}