...
{
    addSpecification("name", "Shadow Rupture");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple to rupture the shadow boundary within a target, releasing a burst of void energy.");
    ...
    addSpecification("command template", "shadow rupture [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## rupture##InitiatorReflexive## the shadow within ##TargetName##, releasing void energy.");
}
