...
protected void Setup()
{
    ...
    addSpecification("description", "This research 41.");
    ...
    addPrerequisite("level", (["type": "level", "guild": "/guilds/drambor-edlothiad/drambor-edlothiad.c", "value": supreme-agility]));
