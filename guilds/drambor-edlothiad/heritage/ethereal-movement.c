...
protected void Setup()
{
    ...
    addSpecification("description", "This research grants near-ethereal fluidity of movement.");

    addPrerequisite("/guilds/drambor-edlothiad/heritage/dance-of-shadows.c", (["type": "research"]));
