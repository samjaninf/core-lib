...
{
    addSpecification("name", "Chaos Enchantment");
    addSpecification("source", "Drambor Edlothiad");
    addSpecification("description", "This research provides the knowledge to "
        "infuse a wielded blade with chaotic energy.");

    addPrerequisite("/guilds/drambor-edlothiad/enchantment/force-enchantment.c", (["type": "research"]));
    ...
    addSpecification("bonus chaos enchantment", 6);
    ...
    addSpecification("command template", "Chaos Enchantment");
    addSpecification("use ability message", "Chaotic energy swirls unpredictably around ##InitiatorPossessive## blade.");
}