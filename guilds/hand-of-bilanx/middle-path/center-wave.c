...
{
    addSpecification("name", "Center Wave");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the knowledge of the center wave. A wave of the fourth truth's centering energy that sweeps over all enemies.");
    ...
    addSpecification("event handler", "centerWaveEvent");
    addSpecification("command template", "center wave");
    addSpecification("use ability message", "##InitiatorName## releases a center wave of the fourth truth.");
}