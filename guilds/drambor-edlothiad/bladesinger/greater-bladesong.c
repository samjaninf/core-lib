...
protected void Setup()
{
    ...
    addPrerequisite("/guilds/drambor-edlothiad/bladesinger/harmonic-precision.c", (["type": "research"]));
    ...
    addSpecification("use ability message", "##InitiatorName## ##Infinitive::begin## the Greater Bladesong, blade and voice moving as one.");
}