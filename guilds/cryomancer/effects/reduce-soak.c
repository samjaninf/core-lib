...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides knowledge of the cryomancer spell construction component for reducing soak.");

    addPrerequisite("/guilds/cryomancer/effects/reduce-defense.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "cryomancerReduceSoakEvent");
}
