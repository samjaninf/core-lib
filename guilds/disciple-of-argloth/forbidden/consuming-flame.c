...
{
    addSpecification("name", "Consuming Flame");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple to manifest a consuming flame of dark energy that burns away a target's life force completely.");
    ...
    addSpecification("command template", "consuming flame [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## manifest##InitiatorReflexive## a consuming flame of dark energy upon ##TargetName##.");
}
