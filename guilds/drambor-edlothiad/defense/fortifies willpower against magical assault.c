...
protected void Setup()
{
    ...
    addSpecification("description", "This research 23.");
    ...
    addPrerequisite("level", (["type": "level", "guild": "/guilds/drambor-edlothiad/drambor-edlothiad.c", "value": arcane-absorption]));
