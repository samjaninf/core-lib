...
{
    addSpecification("name", "Death Blossom");
    addSpecification("source", "ranger");
    addSpecification("description", "This skill provides the ranger "
        "with the knowledge to bloom into a deadly dance of blades.");
    ...
    addSpecification("stamina point cost", 185);
    addSpecification("cooldown", 85);

    addSpecification("event handler", "deathblossomEvent");
    addSpecification("command template", "death blossom [at ##Target##]");
