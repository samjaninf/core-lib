...
protected void Setup()
{
    ...
    addSpecification("command template", "sand toss [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::deliver## a brutal sand toss "
        "to ##TargetName##.");
