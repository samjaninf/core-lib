...
{
    addSpecification("name", "Plague of Wounds");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the plague of wounds. The priest slams the wounding "
        "pan down across all enemies simultaneously, inflicting the harm "
        "of many individual woundings in a single pulse.");
    ...
    addPrerequisite("/guilds/hand-of-bilanx/healing-and-harm/greater-wounding.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "plagueOfWoundsEvent");
    addSpecification("command template", "plague of wounds");
    addSpecification("use ability message", "##InitiatorName## slams the "
        "wounding pan down and a wave of harm ripples outward, striking "
