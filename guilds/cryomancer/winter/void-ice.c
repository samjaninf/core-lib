...
{
    addSpecification("name", "Void Ice");
    addSpecification("source", "cryomancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the void ice spell.");
    ...
    addSpecification("event handler", "voidIceEvent");
    addSpecification("command template", "void ice [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## ##Infinitive::conjure## ice drawn from the void between worlds and hurls it at ##TargetName##.");
}
