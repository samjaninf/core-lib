...
{
    addSpecification("name", "Keen Strike");
    ...
    addSpecification("command template", "keen strike [at ##Target##]");
    addSpecification("event handler", "keenStrikeEvent");
    addSpecification("use ability message",
        "##InitiatorName## deliver##InitiatorReflexive## a keen sensory strike against ##TargetName##.");
    addSpecification("use ability fail message",
        "You failed to land a keen strike against ##TargetName##.");
    addSpecification("use ability cooldown message",
        "You must wait before attempting a keen strike again.");
