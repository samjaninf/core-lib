...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides the user with the "
        "knowledge of the cryomancer spell construction component for "
        "siphoning life from a target to fortify the caster.");

    addPrerequisite("/guilds/cryomancer/effects/invigorating-siphon.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "cryomancerFortifyingSiphonEvent");
}
