...
{
    addSpecification("name", "Sentence of the Scales");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the sentence of the scales spell. At the height of "
        "the fifth truth, the priest speaks the final sentence of Bilanx "
        "and the scales fall upon an enemy with the weight of all "
        "transgressions against equilibrium - a devastating blast of "
    ...
    addSpecification("event handler", "sentenceOfTheScalesEvent");
    addSpecification("command template",
        "sentence of the scales [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## speaks the "
        "final sentence. The scales of Bilanx descend in full upon "
        "##TargetName## and the weight of their every transgression "
        "against the balance crashes into them at once.");
}
