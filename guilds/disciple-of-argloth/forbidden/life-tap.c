...
protected void Setup()
{
    ...
    addSpecification("description", "This research teaches the Disciple to tap directly into a target's life force, draining it and transferring it to themselves.");
    ...
    addSpecification("command template", "life tap [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## tap##InitiatorReflexive## the life force of ##TargetName##, draining their vitality.");
}
