...
protected void Setup()
{
    ...
    addSpecification("command template", "toxic strike [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::administer## toxic strike "
        "to ##TargetName##.");
