...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides knowledge of the cryomancer spell construction component for siphoning spell points from a target.");

    addPrerequisite("/guilds/cryomancer/effects/siphon-hp.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "cryomancerSiphonSpellPointsEvent");
}
