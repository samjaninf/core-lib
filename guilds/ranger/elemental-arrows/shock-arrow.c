...
{
    addSpecification("name", "Shock Arrow");
    addSpecification("source", "ranger");
    addSpecification("description", "This skill provides the ranger "
        "with the knowledge to charge an arrow with lightning.");
    ...
    addSpecification("event handler", "shockarrowEvent");
    addSpecification("command template", "shock arrow [at ##Target##]");
