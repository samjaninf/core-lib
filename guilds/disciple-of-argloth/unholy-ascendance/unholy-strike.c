...
{
    addSpecification("name", "Unholy Strike");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "The unholy strike - a devastating blood attack that draws on the full power of the necromancer adept's covenant.");
    ...
    addSpecification("command template", "unholy strike [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## deliver##InitiatorReflexive## an unholy strike upon ##TargetName##.");
}
