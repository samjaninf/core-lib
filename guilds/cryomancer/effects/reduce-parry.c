...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides knowledge of the cryomancer spell construction component for reducing parry.");

    addPrerequisite("/guilds/cryomancer/effects/reduce-dodge.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "cryomancerReduceParryEvent");
}