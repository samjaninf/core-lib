...
{
    addSpecification("name", "Equilibrium Siphon");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the equilibrium siphon spell. The purest expression "
        "of Bilanx's first truth, it draws vitality from a foe and restores "
        "it to the caster, harming and healing in a single balanced act.");
    ...
    addSpecification("event handler", "equilibriumSiphonEvent");
    addSpecification("command template", "equilibrium siphon [at ##Target##]");
    addSpecification("use ability message", "A thread of grey light arcs from "
        "##TargetName## to ##InitiatorName## as ##InitiatorSubjective## "
        "##Infinitive::draw## the foe's vitality across the scale and into "
        "##InitiatorReflexive##.");
}
