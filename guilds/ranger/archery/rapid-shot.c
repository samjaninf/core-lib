...
{
    addSpecification("name", "Rapid Shot");
    addSpecification("source", "ranger");
    addSpecification("description", "This skill provides the ranger "
        "with the knowledge to fire multiple arrows in rapid succession.");
    ...
    addSpecification("event handler", "rapidshotEvent");
    addSpecification("command template", "rapid shot [at ##Target##]");
