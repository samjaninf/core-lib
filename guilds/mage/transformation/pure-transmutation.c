...
{
    addSpecification("name", "Pure Transmutation");
    addSpecification("source", "mage");
    addSpecification("description", "This skill provides the mage with "
        "knowledge of pure transmutation, enhancing all "
    ...
    addPrerequisite("/guilds/mage/transformation/transmutation-mastery.c",
        (["type": "research"]));
