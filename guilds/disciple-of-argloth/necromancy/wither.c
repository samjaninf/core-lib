...
protected void Setup()
{
    ...
    addSpecification("description", "This research teaches the Disciple to "
        "drain the strength and vitality from a foe, leaving them withered and "
        "enfeebled.");
    ...
    addSpecification("command template", "wither [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## drain##InitiatorReflexive## the strength from ##TargetName##, leaving them withered.");
