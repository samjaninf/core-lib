...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides the knowledge to "
        "freeze a wielded blade with the cold of entropy itself.");

    addPrerequisite("/guilds/drambor-edlothiad/enchantment/absolute-zero-enchantment.c", (["type": "research"]));
    ...
    addSpecification("command template", "Entropic Frost");
    addSpecification("use ability message", "The cold of entropy itself radiates from ##InitiatorPossessive## blade.");
}