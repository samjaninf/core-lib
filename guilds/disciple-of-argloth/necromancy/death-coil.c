...
protected void Setup()
{
    ...
    addSpecification("description", "This research teaches the Disciple to bind a target in coils of death energy, draining their stamina and slowing their movement.");
    ...
    addSpecification("use ability message", "##InitiatorName## bind##InitiatorReflexive## ##TargetName## in coils of death energy.");
}
