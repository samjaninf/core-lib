...
{
    addSpecification("name", "Oracle Bolt");
    addSpecification("source", "mage");
    addSpecification("description", "A divination-school attack spell.");

    addPrerequisite("/guilds/mage/divination/expose-vulnerability.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "oracle bolt [at ##Target##]");
    addSpecification("event handler", "oracleBoltEvent");
    addSpecification("use ability message",
        "##InitiatorName## hurl##InitiatorReflexive## an oracle bolt of prophetic force at ##TargetName##.");
    addSpecification("use ability fail message",
        "You failed to hurl an oracle bolt at ##TargetName##.");
    addSpecification("use ability cooldown message",
        "You must wait before hurling another oracle bolt.");
