...
protected void Setup()
{
    ...
    addSpecification("description", "This research teaches the Disciple to touch a target with the oblivion of the void - an emptiness so total that it erases their connection to all vital forces.");
    ...
    addSpecification("command template", "oblivion touch [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## touch##InitiatorReflexive## ##TargetName## with the oblivion of the void.");
