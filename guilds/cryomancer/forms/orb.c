...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides knowledge of a concentrated orb of cold that detonates on impact.");

    addPrerequisite("/guilds/cryomancer/forms/blast.c",
        (["type": "research"]));
