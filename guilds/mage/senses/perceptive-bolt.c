...
{
    addSpecification("name", "Perceptive Bolt");
    ...
    addSpecification("command template", "perceptive bolt [at ##Target##]");
    addSpecification("event handler", "perceptiveBoltEvent");
    addSpecification("use ability message",
        "##InitiatorName## hurl##InitiatorReflexive## a bolt of perceptive force at ##TargetName##.");
    addSpecification("use ability fail message",
        "You failed to hurl a perceptive bolt at ##TargetName##.");
    addSpecification("use ability cooldown message",
        "You must wait before hurling another perceptive bolt.");
