...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides the user with the "
        "knowledge of the greater mending spell. A fuller draught of the "
        "restorative current, it mends grievous wounds while the priest "
        "holds the wounding pan of the scale in careful check.");
    ...
    addSpecification("event handler", "greaterMendingEvent");
    addSpecification("command template", "greater mending [at ##Target##]");
    addSpecification("use ability message", "A radiant column of silver light "
        "pours from ##InitiatorPossessive::Name## hands, washing over "
        "##TargetName## and closing even the gravest of wounds.");
}
