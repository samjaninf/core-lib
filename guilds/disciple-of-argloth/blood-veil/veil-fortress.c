...
{
    addSpecification("name", "Veil Fortress");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research expands the Blood Veil into a true fortress of blood energy, granting broad resistance across all damage types.");
