...
{
    addSpecification("name", "Crafting Efficiency III");
    addSpecification("source", "runeskald");
    addSpecification("description", "This skill provides the runeskald with the "
        "knowledge to decrease the cost of their rune "
        "crafting abilities.");
    ...
    addPrerequisite("/guilds/runeskald/rune-crafting/crafting-efficiency-ii.c",
        (["type": "research"]));
