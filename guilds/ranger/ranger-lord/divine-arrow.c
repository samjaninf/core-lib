...
{
    addSpecification("name", "Divine Arrow");
    addSpecification("source", "ranger");
    addSpecification("description", "This skill provides the ranger "
        "lord with a devastating attack.");

    addPrerequisite("/guilds/ranger/ranger-lord/lords-supremacy.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "divinearrowEvent");
    addSpecification("command template", "divine arrow [at ##Target##]");
