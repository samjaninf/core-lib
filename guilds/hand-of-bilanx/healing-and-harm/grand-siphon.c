...
{
    addSpecification("name", "Grand Siphon");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the grand siphon. The priest draws a sweeping tithe "
        "of life from all enemies in the area, routing the full harvest "
        "through the scales and returning it to all allies.");
    ...
    addPrerequisite("/guilds/hand-of-bilanx/healing-and-harm/life-tithe.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "grandSiphonEvent");
    addSpecification("command template", "grand siphon");
    addSpecification("use ability message", "##InitiatorName## sweeps both "
        "arms wide and the scales claim a tithe of life from every enemy "
        "present, pouring it back into ##InitiatorPossessive## allies.");
}
