...
protected void Setup()
{
    ...
    addSpecification("description", "This research teaches the moonfire spell, "
        "silvery flames that burn with elven magic.");
    addPrerequisite("/guilds/drambor-edlothiad/sorcery/moonbeam.c", (["type": "research"]));
