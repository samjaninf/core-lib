...
{
    addSpecification("name", "Mortal Wound");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple to inflict a wound that bleeds with death energy, dealing ongoing necrotic damage to the target.");
    ...
    addSpecification("command template", "mortal wound [at ##Target##]");
    addSpecification("use ability message",
        "##InitiatorName## afflict##InitiatorReflexive## ##TargetName## "
        "with a mortal wound that bleeds with death energy.");
}
