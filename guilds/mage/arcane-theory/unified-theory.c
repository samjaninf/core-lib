...
{
    addSpecification("name", "Unified Theory");
    addSpecification("source", "mage");
    addSpecification("description", "A unified understanding of all magical theory enhances all abilities.");

    addPrerequisite("level",
        (["type": "level", "guild": "mage", "value": 5]));
    addPrerequisite("/guilds/mage/arcane-theory/magical-attunement.c",
        (["type": "research"]));
