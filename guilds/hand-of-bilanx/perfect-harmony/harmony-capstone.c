...
{
    addSpecification("name", "Harmony Capstone");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the knowledge of the harmony capstone. The most powerful pure-damage expression of the eighth truth, reserved for the greatest enemies of balance.");
    ...
    addSpecification("event handler", "harmonyCapstoneEvent");
    addSpecification("command template", "harmony capstone [##Target##]");
    addSpecification("use ability message", "##InitiatorName## unleashes the full capstone of the eighth truth upon ##TargetName##.");
}