...
{
    addSpecification("name", "Obliteration");
    addSpecification("source", "mage");
    addSpecification("description", "A destruction-school attack spell.");

    addPrerequisite("/guilds/mage/destruction/entropy-wave.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "obliterate [at ##Target##]");
    addSpecification("event handler", "obliterationEvent");
    addSpecification("use ability message",
        "##InitiatorName## obliterate##InitiatorReflexive## ##TargetName## with a torrent of destructive power.");
    addSpecification("use ability fail message",
        "You failed to obliterate ##TargetName##.");
    addSpecification("use ability cooldown message",
        "You must wait before attempting obliteration again.");
