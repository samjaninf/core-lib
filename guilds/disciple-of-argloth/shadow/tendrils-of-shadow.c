...
{
    addSpecification("name", "Tendrils of Shadow");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple to extend tendrils of shadow from their own form, lashing a target.");
    ...
    addSpecification("command template", "tendrils of shadow [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## lash##InitiatorReflexive## ##TargetName## with writhing tendrils of shadow.");
}
