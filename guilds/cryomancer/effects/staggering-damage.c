...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides knowledge of dealing cold damage that staggers and reduces the target's attack capabilities.");
    ...
    addSpecification("event handler", "cryomancerStaggeringDamageEvent");
}
