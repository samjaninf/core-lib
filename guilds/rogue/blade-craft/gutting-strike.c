...
{
    addSpecification("name", "Gutting Strike");
    addSpecification("source", "rogue");
    addSpecification("description", "This research provides the rogue with "
        "the Gutting Strike blade combat technique.");
    ...
    addSpecification("command template", "gutting strike [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::deliver## a precise gutting strike "
        "at ##TargetName##.");
