...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides knowledge of the cryomancer spell construction component for siphoning hit points from a target.");

    addPrerequisite("/guilds/cryomancer/effects/damage-hp.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "cryomancerSiphonHitPointsEvent");
}
