...
{
    addSpecification("name", "Nature's Wrath Arrow");
    addSpecification("source", "ranger");
    addSpecification("description", "This skill provides the ranger "
        "with the knowledge to unleash nature's corrosive wrath.");
    ...
    addSpecification("event handler", "natureswratharrowEvent");
    addSpecification("command template", "natures wrath [at ##Target##]");
