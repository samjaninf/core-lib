...
{
    addSpecification("name", "Equilibrium Surge");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the equilibrium surge spell. The priest releases the "
        "tension between their physical and magical natures in a single "
        "explosive discharge, and the collision of equal physical and "
        "arcane forces devastates the target.");
    ...
    addSpecification("event handler", "equilibriumSurgeEvent");
    addSpecification("command template", "equilibrium surge [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::release## the tension between their twin natures in "
        "a single devastating surge. Physical and arcane force collide and "
        "the shockwave strikes ##TargetName##.");
}
