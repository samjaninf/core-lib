...
{
    addSpecification("name", "Scales' Rebuke");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the knowledge of the scales' rebuke. The priest sweeps the scales' authority across the entire area, rebuking all who carry imbalance.");
    ...
    addPrerequisite("/guilds/hand-of-bilanx/scales-of-judgment/scales-punishment.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "scalesRebukeEvent");
    addSpecification("command template", "scales rebuke");
    addSpecification("use ability message", "##InitiatorName## releases the scales' rebuke across the area.");
}