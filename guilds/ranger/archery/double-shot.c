...
{
    addSpecification("name", "Double Shot");
    addSpecification("source", "ranger");
    addSpecification("description", "This skill provides the ranger "
        "with the knowledge to fire two arrows simultaneously.");
    ...
    addSpecification("event handler", "doubleshotEvent");
    addSpecification("command template", "double shot [at ##Target##]");
