...
{
    addSpecification("name", "Fracture the Unworthy");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the "
        "knowledge of fracture the unworthy. The hierophant shatters the "
        "spiritual armor of a target, making them vulnerable to further "
        "workings of the seventh truth.");
    ...
    addPrerequisite("/guilds/hand-of-bilanx/hand-of-the-scales/scales-reckoning.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "fractureTheUnworthyEvent");
    addSpecification("command template",
        "fracture the unworthy [##Target##]");
    addSpecification("use ability message", "##InitiatorName## fractures "
        "the spiritual defenses of ##TargetName##.");
}
