...
{
    addSpecification("name", "Form of Reckoning");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the knowledge of the form of reckoning. The sixth truth expressed as a mighty strike that carries the full weight of perfect balance.");
    ...
    addSpecification("event handler", "formOfReckoningEvent");
    addSpecification("command template", "form of reckoning [##Target##]");
    addSpecification("use ability message", "##InitiatorName## delivers the form of reckoning upon ##TargetName##.");
}