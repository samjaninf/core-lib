...
{
    addSpecification("name", "Bone Crusher");
    addSpecification("source", "rogue");
    addSpecification("description", "This research provides the rogue with "
        "the Bone Crusher dirty fighting technique.");

    addPrerequisite("/guilds/rogue/dirty-fighting/dirty-mastery.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "bone crusher [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::deliver## a brutal bone crusher "
        "to ##TargetName##.");
