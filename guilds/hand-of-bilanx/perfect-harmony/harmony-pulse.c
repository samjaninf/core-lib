...
{
    addSpecification("name", "Harmony Pulse");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the knowledge of the harmony pulse. The Hand releases a pulse of balanced energy that strikes a target.");
    ...
    addSpecification("event handler", "harmonyPulseEvent");
    addSpecification("command template", "harmony pulse [##Target##]");
    addSpecification("use ability message", "##InitiatorName## releases a pulse of harmony at ##TargetName##.");
}