...
{
    addSpecification("name", "Blood Shriek");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple "
        "to release a keening shriek of blood-saturated energy, driving "
        "fear and pain into all enemies nearby.");
    SetupResearch();

    addPrerequisite(sprintf(
        "/guilds/disciple-of-argloth/paths/%s/blood/crimson-brand.c",
    ...
    addSpecification("spell point cost", 230);
    ...
    addSpecification("command template", "blood shriek");
    addSpecification("use ability message",
        "##InitiatorName## release##InitiatorReflexive## a shattering "
        "blood shriek that tears at all nearby foes.");
}
