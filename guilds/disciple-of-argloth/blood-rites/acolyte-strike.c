...
{
    addSpecification("name", "Acolyte Strike");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "The basic blood strike taught to every acolyte of Argloth as their first combat ability.");
    ...
    addSpecification("command template", "acolyte strike [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## deliver##InitiatorReflexive## the acolyte strike at ##TargetName##.");
}
