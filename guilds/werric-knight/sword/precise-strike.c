...
{
    addSpecification("name", "Precise Strike");
    addSpecification("source", "Werric Knight");
    addSpecification("description", "This research provides the ability to "
        "make a carefully aimed strike at a vulnerable point, dealing enhanced damage.");
    ...
    addPrerequisite("/guilds/werric-knight/sword/sword-training.c",
        (["type":"research"]));
    ...
    addSpecification("command template", "precise strike [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## ##Infinitive::make## "
        "a precise strike at ##TargetName##.");
