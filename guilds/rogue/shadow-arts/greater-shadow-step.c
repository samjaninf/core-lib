...
{
    addSpecification("name", "Greater Shadow Step");
    addSpecification("source", "rogue");
    addSpecification("description", "This research provides the rogue with "
        "the Greater Shadow Step shadow technique.");

    addPrerequisite("/guilds/rogue/shadow-arts/shadow-mastery-ii.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "greater shadow step [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::unleash## greater shadow step "
        "upon ##TargetName##.");
    ...
    addSpecification("modifiers", ({
        ...
        ([
            "type": "research",
            "research item": "/guilds/rogue/shadow-arts/shadow-mastery-iii.c",
