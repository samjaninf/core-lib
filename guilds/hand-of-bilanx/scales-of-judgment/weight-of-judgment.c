...
{
    addSpecification("name", "Weight of Judgment");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the weight of judgment spell. The priest places the "
        "scales against a foe and lets their own transgressions become a "
        "weapon. Those who have tipped the balance far toward evil or fanaticism "
        "suffer the weight of all they have done.");
    ...
    addSpecification("event handler", "weightOfJudgmentEvent");
    addSpecification("command template",
        "weight of judgment [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::hold## up one hand and invisible scales descend "
        "around ##TargetName##, weighing them against the standard of "
        "balance and finding them wanting.");
}
