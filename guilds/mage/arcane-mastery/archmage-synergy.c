...
{
    addSpecification("name", "Archmage Synergy");
    addSpecification("source", "mage");
    addSpecification("description", "Archmage synergies maximize the power of all magical abilities.");

    addPrerequisite("level",
        (["type": "level", "guild": "mage", "value": 72]));
    addPrerequisite("/guilds/mage/arcane-mastery/archmage-wisdom.c",
        (["type": "research"]));
