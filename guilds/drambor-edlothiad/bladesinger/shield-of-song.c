...
{
    addSpecification("name", "Shield of Song");
    addSpecification("source", "Drambor Edlothiad");
    addSpecification("description", "This research provides the knowledge to "
        "create a shield of harmonic energy around the singer.");

    addPrerequisite("/guilds/drambor-edlothiad/bladesinger/warding-song.c", (["type": "research"]));
    ...
    addSpecification("command template", "shield of song");
    addSpecification("use ability message", "A shimmering shield of harmonic energy surrounds ##InitiatorName##.");
}