...
{
    addSpecification("name", "Whirling Blades");
    addSpecification("source", "rogue");
    addSpecification("description", "This research provides the rogue with "
        "the Whirling Blades blade combat technique.");
    ...
    addSpecification("command template", "whirling blades [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## "
        "##Infinitive::deliver## a precise whirling blades "
        "at ##TargetName##.");
