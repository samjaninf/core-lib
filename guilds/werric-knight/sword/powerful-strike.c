...
{
    addSpecification("name", "Powerful Strike");
    addSpecification("source", "Werric Knight");
    addSpecification("description", "This research provides the user with the "
        "knowledge of a powerful overhead strike. By channeling their "
        "strength into a single devastating blow, the knight can deal "
        "tremendous damage.");

    addSpecification("limited by", (["equipment":({ "dagger", "short sword",
        "long sword", "hand and a half sword", "two-handed sword" }) ]));

    addPrerequisite("/guilds/werric-knight/sword/root.c",
        (["type":"research"]));
    ...
    addSpecification("command template", "powerful strike [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## ##Infinitive::deliver## "
        "a powerful overhead strike to ##TargetName##.");
