...
{
    addSpecification("name", "Shadow Bind");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple to bind a target in bands of solid shadow, restricting their movement.");
    ...
    addSpecification("command template", "shadow bind [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## bind##InitiatorReflexive## ##TargetName## in bands of solid shadow.");
