...
protected void Setup()
{
	...
	addSpecification("description", "This research provides the user with the "
		"knowledge of the permafrost eruption spell. By means of this, the "
		"cryomancer causes the very ground to erupt in frozen spikes "
		"of permafrost, impaling all foes in the area.");

	addPrerequisite("/guilds/cryomancer/frost/absolute-zero.c",
		(["type": "research"]));
	...
	addSpecification("event handler", "permafrostEruptionEvent");
	addSpecification("command template", "permafrost eruption");
	addSpecification("use ability message", "##InitiatorName## "
		"##Infinitive::cause## the very ground beneath ##TargetName## "
		"to erupt in frozen spikes of permafrost.");
}
