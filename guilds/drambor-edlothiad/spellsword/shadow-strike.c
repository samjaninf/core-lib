...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides the knowledge to "
        "channel shadow energy through a melee strike.");

    addPrerequisite("/guilds/drambor-edlothiad/spellsword/spell-blade-conditioning.c", (["type": "research"]));
    ...
    addSpecification("command template", "shadow strike");
    addSpecification("use ability message", "Shadow energy erupts from ##InitiatorPossessive## blade.");
}