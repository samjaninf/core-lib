...
{
    addSpecification("name", "Primal Rite Mastery");
    addSpecification("source", "druid");
    addSpecification("description", "This research represents the pinnacle "
        "of the druid's ritual knowledge, maximally amplifying all primal "
        "rites.");
    ...
    addPrerequisite("/guilds/druid/primal-rites/elder-rites.c",
        ([ "type": "research" ]));
