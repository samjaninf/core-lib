...
protected void Setup()
{
    ...
    addSpecification("description", "This skill provides the ranger "
        "with the knowledge to unleash an unstoppable storm of blades.");

    addPrerequisite("/guilds/ranger/blade-work/dual-mastery.c",
        (["type": "research"]));
    ...
    addSpecification("stamina point cost", 275);
    addSpecification("cooldown", 120);

    addSpecification("event handler", "bladestormEvent");
