...
protected void Setup()
{
    ...
    addSpecification("description", "This research 45.");
    ...
    addPrerequisite("level", (["type": "level", "guild": "/guilds/drambor-edlothiad/drambor-edlothiad.c", "value": invulnerability]));
