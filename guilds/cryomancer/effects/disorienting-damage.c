...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides knowledge of dealing cold damage that disorients and reduces the target's defense.");
    ...
    addSpecification("event handler", "cryomancerDisorientingDamageEvent");
}