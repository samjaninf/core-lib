...
{
    addSpecification("name", "Dying Curse");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple to afflict a target with a dying curse - a necrotic hex that weakens them with each passing moment.");

    addPrerequisite(
        "/guilds/disciple-of-argloth/death/last-breath.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "dying curse [at ##Target##]");
    addSpecification("use ability message",
        "##InitiatorName## afflict##InitiatorReflexive## ##TargetName## "
        "with a dying curse of necrotic dark energy.");
}
