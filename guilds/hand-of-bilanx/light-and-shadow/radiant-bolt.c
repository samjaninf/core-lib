...
{
    addSpecification("name", "Radiant Bolt");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the radiant bolt spell. The priest concentrates a "
        "measure of pure, balanced light into a lance of radiant force and "
        "hurls it at a foe - not as a holy weapon, but as one half of the "
        "scale brought to bear.");
    ...
    addSpecification("event handler", "radiantBoltEvent");
    addSpecification("command template", "radiant bolt [at ##Target##]");
    addSpecification("use ability message", "A compact lance of pale silver "
        "light leaps from ##InitiatorPossessive::Name## outstretched hand "
        "and strikes ##TargetName## with the measured force of balanced "
        "radiance.");
}
