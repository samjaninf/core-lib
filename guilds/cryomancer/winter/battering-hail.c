...
{
    addSpecification("name", "Battering Hail");
    addSpecification("source", "cryomancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the battering hail spell.");
    ...
    addSpecification("event handler", "batteringHailEvent");
    addSpecification("command template", "battering hail [at ##Target##]");
    addSpecification("use ability message", "Massive hailstones erupt from ##InitiatorPossessive::Name## outstretched hand, battering ##TargetName##.");
}
