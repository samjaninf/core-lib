...
{
    addSpecification("name", "Sever Soul");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple to sever the link between a target's soul and body, dealing severe magical damage.");

    addPrerequisite(
        "/guilds/disciple-of-argloth/death/reaping-wave.c",
        (["type": "research"]));
    ...
    addSpecification("command template", "sever soul [at ##Target##]");
    addSpecification("use ability message",
        "##InitiatorName## sever##InitiatorReflexive## the link between "
        "##TargetName##'s soul and body with pure death energy.");
}
