...
{
    addSpecification("name", "Suffocating Cold");
    addSpecification("source", "cryomancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the suffocating cold spell.");

    addPrerequisite("/guilds/cryomancer/winter/numbing-cold.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "suffocatingColdEvent");
    addSpecification("command template", "suffocating cold [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## ##Infinitive::wrap## ##TargetName## in a suffocating shroud of freezing cold.");
}
