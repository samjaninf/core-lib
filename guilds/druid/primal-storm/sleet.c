...
{
    addSpecification("name", "Sleet");
    addSpecification("source", "druid");
    addSpecification("description", "This research grants the druid knowledge of the sleet spell, pelting a foe with a barrage of ice and freezing rain.");
    ...
    addSpecification("command template", "sleet ##Target##");
    addSpecification("use ability message", "##InitiatorName## ##Infinitive::call## a torrent of sleet and freezing rain crashing down upon ##TargetName##.");
}
