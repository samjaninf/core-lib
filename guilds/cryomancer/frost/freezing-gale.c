...
{
    addSpecification("name", "Freezing Gale");
    addSpecification("source", "cryomancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the freezing gale spell. By means of this, the "
        "cryomancer unleashes a powerful gale of freezing wind that "
        "engulfs all nearby foes.");

    addPrerequisite("/guilds/cryomancer/frost/rime-burst.c",
        (["type": "research"]));
    ...
    addSpecification("event handler", "freezingGaleEvent");
    addSpecification("command template", "freezing gale [at ##Target##]");
    addSpecification("use ability message", "A powerful gale of freezing "
        "wind erupts from ##InitiatorPossessive::Name## and engulfs "
        "##TargetName##.");
}
