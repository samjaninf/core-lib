...
{
    addSpecification("name", "Heart Seeker");
    addSpecification("source", "ranger");
    addSpecification("description", "This skill provides the ranger "
        "with the knowledge to aim for the heart with unerring accuracy.");
    ...
    addSpecification("event handler", "heartseekerEvent");
    addSpecification("command template", "heart seeker [at ##Target##]");
