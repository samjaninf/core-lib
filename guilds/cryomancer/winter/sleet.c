...
protected void Setup()
{
    ...
    addSpecification("event handler", "sleetEvent");
    addSpecification("command template", "sleet [at ##Target##]");
    addSpecification("use ability message", "A stinging torrent of sleet flies from ##InitiatorPossessive::Name## outstretched arm into ##TargetName##.");
}
