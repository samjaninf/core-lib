...
protected void Setup()
{
    ...
    addSpecification("description", "This research provides knowledge of the cryomancer spell construction component for reducing attack.");
    ...
    addSpecification("event handler", "cryomancerReduceAttackEvent");
}
