...
{
    addSpecification("name", "Talons of Ice");
    addSpecification("source", "cryomancer");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the talons of ice spell.");
    ...
    addSpecification("event handler", "talonsOfIceEvent");
    addSpecification("command template", "talons of ice [at ##Target##]");
    addSpecification("use ability message", "##InitiatorName## ##Infinitive::send## razor-sharp talons of ice slashing toward ##TargetName##.");
}