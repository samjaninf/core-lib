...
protected void Setup()
{
    ...
    addSpecification("description", "This research teaches the chain lightning "
        "spell, an arc of electricity that leaps between enemies.");
    ...
    addSpecification("use ability message", "Arcs of lightning leap from "
        "##InitiatorPossessive## fingertips, chaining between nearby enemies.");
}
