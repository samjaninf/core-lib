...
protected void Setup()
{
    ...
    addSpecification("description", "This research teaches the Disciple the Rite of Ruin - the same ceremony that Argloth's army performed at the beginning of the Age of Ruin, adapted for single combat.");
    ...
    addSpecification("hit point cost", 90);
    ...
    addSpecification("command template", "rite of ruin");
    addSpecification("use ability message", "##InitiatorName## begin##InitiatorReflexive## the Rite of Ruin, the ceremony that once heralded the Age of Ruin.");
}
