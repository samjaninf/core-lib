...
{
    addSpecification("name", "Ultimate Corruption");
    addSpecification("source", "Disciple of Argloth");
    addSpecification("description", "This research teaches the Disciple the ultimate corruption - a ritual of total necrotic saturation that begins to unmake all living things in a wide area.");
    ...
    addSpecification("command template", "ultimate corruption");
    addSpecification("use ability message", "##InitiatorName## unleash##InitiatorReflexive## the ultimate corruption, saturating all nearby life with necrotic annihilation.");
}
