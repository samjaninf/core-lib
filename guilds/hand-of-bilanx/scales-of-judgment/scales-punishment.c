...
{
    addSpecification("name", "Scales' Punishment");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the "
        "knowledge of the scales' punishment. After weighing a target "
        "and finding them wanting, the priest delivers a powerful focused "
        "blast of judging force.");
    ...
    addSpecification("event handler", "scalesPunishmentEvent");
    addSpecification("command template", "scales' punishment [##Target##]");
    addSpecification("use ability message", "##InitiatorName## brings "
        "the scales' punishment upon ##TargetName## with measured force.");
}
