...
protected void Setup()
{
    ...
    addSpecification("description", "This research teaches the Disciple to condense shadow into a lance of pure void energy, hurling it at a target.");
    ...
    addSpecification("use ability message", "##InitiatorName## hurl##InitiatorReflexive## an umbral lance of condensed shadow at ##TargetName##.");
}
