...
{
    addSpecification("name", "Cosmic Reckoning");
    addSpecification("source", "Hand of Bilanx");
    addSpecification("description", "This research provides the user with the knowledge of the cosmic reckoning. The Hand channels the most extreme expression of the seventh truth into a single devastating targeted strike.");
    ...
    addSpecification("spell point cost", 64);
    ...
    addSpecification("event handler", "cosmicReckoningEvent");
    addSpecification("command template", "cosmic reckoning [##Target##]");
    addSpecification("use ability message", "##InitiatorName## delivers the cosmic reckoning upon ##TargetName##.");
}