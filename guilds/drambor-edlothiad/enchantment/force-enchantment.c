...
protected void Setup()
{
    ...
    addPrerequisite("/guilds/drambor-edlothiad/enchantment/energy-enchantment.c", (["type": "research"]));
    ...
    addSpecification("command template", "Force Enchantment");
    addSpecification("use ability message", "Concentrated force radiates from ##InitiatorPossessive## blade.");
}