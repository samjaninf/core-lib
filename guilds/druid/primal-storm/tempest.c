...
protected void Setup()
{
    ...
    addSpecification("description", "This research grants the druid knowledge of the tempest spell, calling the full fury of a primal storm upon a foe.");

    addPrerequisite("/guilds/druid/primal-storm/root.c",
        ([ "type": "research" ]));

    addPrerequisite("/guilds/druid/primal-storm/arctic-gale.c",
        ([ "type": "research" ]));
    ...
    addSpecification("command template", "tempest ##Target##");
    addSpecification("use ability message", "##InitiatorName## ##Infinitive::call## down the wrath of the sky itself and a howling tempest of wind and ice ##Infinitive::descend## upon ##TargetName##.");
}
