...
{
    addSpecification("name", "Piercing Shot");
    addSpecification("source", "ranger");
    addSpecification("description", "This skill provides the ranger "
        "with the knowledge to fire an armor-piercing arrow.");
    ...
    addSpecification("event handler", "piercingshotEvent");
    addSpecification("command template", "piercing shot [at ##Target##]");
